...
- **Date d'exécution** : 18/12/2025 11:59:13
- **Clients analysés** : 48
- **Clients réussis** : 48
- **Clients échoués** : 0
...
| **wMAPE** | 31.0% | 25.0% | ⚖️ Écart pondéré robuste (métrique principale) |
| **MAPE** | 34.8% | 25.0% | Écart moyen (info, biaisé) |
| **Bias** | 6.5% | 0.0% | Biais directionnel (>0 = surestime, <0 = sous-estime) |
...
|----------|--------|----------------|
| **Appels LLM** | 857 | Nombre de produits prédits par LLM (>2 commandes historiques) |
| **Tokens Total** | 1 572 972 | 1 316 294 prompt + 256 678 completion |
| **Tokens Moyen/Appel** | 1 835 | Tokens moyen par prédiction LLM |
...
*Rapport généré automatiquement le 2025-12-18T10:59:13.484Z*
