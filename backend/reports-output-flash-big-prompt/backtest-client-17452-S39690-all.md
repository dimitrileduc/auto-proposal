...
- **Appels**: 22
- **Tokens**: 35,285 input + 7,083 output = 42,368 total
...
**🔍 Analyse LLM:**
- **Pattern temporel**: Indéterminé (données trop rares)
- **Saisonnalité**: none
- **Tendance**: Hausse marquée (+80%)
- **Outliers détectés**: Aucun

**🧠 Raisonnement LLM:**
L'historique est très limité avec seulement deux points de données. On observe une augmentation significative entre le 26/08 (155u) et le 29/08 (279u). La date de prédiction étant un dimanche (jour hors cycle habituel), selon les guidelines, nous prédisons la quantité du prochain événement de commande probable. En l'absence de données plus régulières, la dernière valeur connue (279u) est conservée comme la référence la plus représentative de la demande actuelle pour ce produit BIO, en privilégiant la tendance récente sur la moyenne historique conformément aux règles de précision B2B en cas de rupture de tendance positive ou de données éparses.
...
- **Saisonnalité**: weak
- **Tendance**: Baisse progressive -38%
- **Outliers détectés**: 100u

**🧠 Raisonnement LLM:**
L'historique montre une commande mensuelle régulière. En 2024 (N-1), le volume était stable à 100u d'août à octobre. Cependant, la donnée la plus récente (août 2025) montre un décrochage significatif à 62u. Conformément aux guidelines B2B, on privilégie la tendance récente sur l'historique lointain N-1. Bien que la date cible soit un dimanche (hors cycle), nous prédisons la quantité du prochain créneau de commande (lundi 13/10). Le volume de 62u est retenu comme nouvelle référence de base.
...
|---------|-------------|--------|
| [LV135] LV Tartinade Basilico 190g | 279 | Stock prédit: 250.7u (26j restants) → prédit 279u mais non commandé |
| [LV143] LV Mayonnaise (huile 70%) 200 ml  | 150 | Stock prédit: 132.2u (22j restants) → prédit 150u mais non commandé |
...
| [LV145] LV Sauce Tartare 200 ml  | 287 | Stock prédit: 16.6u (3j restants) → prédit 287u mais non commandé |
...
*Rapport généré automatiquement le 2025-12-18T10:57:53.418Z*
