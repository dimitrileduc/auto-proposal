...
- **Appels**: 10
- **Tokens**: 9,747 input + 4,657 output = 14,404 total
- **Coût**: $0.0264 (~2.64¢)
...
|---------|--------|------|-----------|----------|------|--------|
| [PF1809] LD SAUCE BEARNAISE 250ML WECK | 200 | 200 | 0.0 | 0.0% | 🎯 exact | 🤖 LLM |
...
<details>
<summary><strong>1. [PF1809] LD SAUCE BEARNAISE 250ML WECK</strong> - LLM: 200u vs Médiane: undefinedu (Réel: 200u)</summary>
...
**🧠 Raisonnement:**
Analyse détaillée de l'historique des commandes pour [PF1809] LD SAUCE BEARNAISE 250ML WECK :

1. Analyse temporelle :
- Les commandes ne sont pas strictement régulières
- Intervalles entre commandes variables :
  * 23/09 → 29/08 : 25 jours
  * 29/08 → 07/08 : 22 jours
  * 07/08 → 19/06 : 49 jours
- Tendance à des commandes plus fréquentes récemment (intervalles de ~25 jours)

2. Analyse des quantités :
- Dernières commandes : 84u, 200u, 200u, 400u
- Variation significative : de 400u à 84u
- Moyenne glissante : environ 221 unités
- Dernière commande (84u) semble être un point bas inhabituel

3. Recommandation :
- Quantité conservatrice basée sur historique récent
- Choix de 200u (moyenne des deux dernières commandes standard)
- Correspond à la tendance récurrente avant la dernière commande réduite

**📅 Analyse Temporelle:**
Commandes irrégulières mais avec une fréquence récente autour de 25 jours, suggérant un rythme de réapprovisionnement qui se stabilise

**📊 Analyse Quantité:**
Variations importantes (84u-400u) avec une moyenne autour de 221 unités. Dernière commande anormalement basse
...
*Rapport généré automatiquement le 2025-11-19T15:55:43.307Z*
