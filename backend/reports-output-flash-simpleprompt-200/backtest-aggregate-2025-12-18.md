...
- **Date d'exécution** : 18/12/2025 12:41:48
...
| **wMAPE** | 43.3% | 36.4% | ⚖️ Écart pondéré robuste (métrique principale) |
| **MAPE** | 45.9% | 38.6% | Écart moyen (info, biaisé) |
...
|----------|--------|----------------|
| **Appels LLM** | 2452 | Nombre de produits prédits par LLM (>2 commandes historiques) |
| **Tokens Total** | 2 690 971 | 2 035 398 prompt + 655 573 completion |
| **Tokens Moyen/Appel** | 1 097 | Tokens moyen par prédiction LLM |
...
*Rapport généré automatiquement le 2025-12-18T11:41:48.357Z*
