...
|----------|--------|----------------|
| **Précision** | 57.1% | 28 produits prédits, 16 corrects |
| **Rappel** | 84.2% | 19 produits réels, 16 détectés |
| **F1-Score** | 68.1% | Score équilibré global |
...
| [REB11] ReBEL chips premium & bio - truffes 125g | 1 | Stock prédit: 0.3u (16j restants) → prédit 1u mais non commandé |
| [WIG01] WIGNAC cidre naturel bio 330ml | 1 | Stock prédit: 0.3u (16j restants) → prédit 1u mais non commandé |
...
|---------|---------------|--------|
| [NUT05] NUTS & BERRIES Bar choco noir gingembre bio 40g | 1 | Jamais commandé avant dans les 120j précédents (pas d'historique) |
| [VID0009] Consigne casier | 19 | Jamais commandé avant dans les 120j précédents (pas d'historique) |
| [VID0010] Consigne casier | 114 | Jamais commandé avant dans les 120j précédents (pas d'historique) |


---

*Rapport généré automatiquement le 2025-12-18T11:40:00.049Z*
