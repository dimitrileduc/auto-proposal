...
| Métrique | Valeur | Interprétation |
|----------|--------|----------------|
| **MAE** | 51.67 unités | Erreur moyenne absolue (symétrique) |
| **wMAPE** | 46.8% | ⚖️ Erreur pondérée robuste (métrique principale) |
| **MAPE** | 34.4% | Erreur moyenne en % (biaisé, pour info) |
| **Bias** | -39.6% | Biais directionnel (>0 = surestime, <0 = sous-estime) |
...
*Rapport généré automatiquement le 2025-12-18T11:36:49.979Z*
