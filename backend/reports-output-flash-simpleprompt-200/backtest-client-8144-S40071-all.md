...
- **Appels**: 2
- **Tokens**: 1,747 input + 635 output = 2,382 total
...
**🔍 Analyse LLM:**
- **Pattern temporel**: Cycle d'environ 21 jours (3 semaines) avec glissement de jour (Lun/Mar)
- **Saisonnalité**: weak
- **Tendance**: Hausse nette de 100% (passage de 80u à 160u)
- **Outliers détectés**: Aucun

**🧠 Raisonnement LLM:**
L'historique récent montre une rupture de tendance claire depuis septembre 2025, où le volume unitaire est passé de 80u à 160u de manière constante sur les 3 dernières commandes. Le client suit un cycle de réapprovisionnement d'environ 20 à 22 jours. La dernière commande datant du 13 octobre, la sollicitation du 2 novembre (20 jours plus tard) s'inscrit parfaitement dans ce rythme de consommation de 160u par cycle. La saisonnalité N-1 à 80u est ignorée au profit de la nouvelle tendance structurelle lourde observée en période récente.
...
|---------|-------------|--------|
| [PF3251] JEFKE CHIVE VINAIGRETTE 5L | 1 | Stock prédit: 75.0u (30j restants) → prédit 1u mais non commandé |
...
*Rapport généré automatiquement le 2025-12-18T11:34:06.600Z*
