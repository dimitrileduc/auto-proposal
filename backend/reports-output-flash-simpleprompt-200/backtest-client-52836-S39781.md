...
| Métrique | Valeur | Interprétation |
|----------|--------|----------------|
| **MAE** | 2.83 unités | Erreur moyenne absolue (symétrique) |
| **wMAPE** | 68.0% | ⚖️ Erreur pondérée robuste (métrique principale) |
| **MAPE** | 72.5% | Erreur moyenne en % (biaisé, pour info) |
| **Bias** | -52.0% | Biais directionnel (>0 = surestime, <0 = sous-estime) |
...
*Rapport généré automatiquement le 2025-12-18T11:41:26.866Z*
