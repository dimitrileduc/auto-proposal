...
| Métrique | Valeur | Interprétation |
|----------|--------|----------------|
| **MAE** | 19.38 unités | Erreur moyenne absolue (symétrique) |
| **wMAPE** | 42.9% | ⚖️ Erreur pondérée robuste (métrique principale) |
| **MAPE** | 50.4% | Erreur moyenne en % (biaisé, pour info) |
| **Bias** | -8.9% | Biais directionnel (>0 = surestime, <0 = sous-estime) |
...
*Rapport généré automatiquement le 2025-12-18T11:35:41.915Z*
