...
- **Appels**: 17
- **Tokens**: 14,066 input + 5,017 output = 19,083 total
...
**🔍 Analyse LLM:**
- **Pattern temporel**: Rythme hebdomadaire irrégulier (7 à 10 jours), majoritairement le lundi
- **Saisonnalité**: none
- **Tendance**: Stagnation parfaite à 31u
- **Outliers détectés**: Aucun

**🧠 Raisonnement LLM:**
Le comportement d'achat sur ce produit est d'une stabilité exceptionnelle avec cinq commandes consécutives de exactement 31 unités sur les trois derniers mois. L'intervalle entre les commandes varie légèrement (souvent autour de 8 jours), mais le volume reste rigide, suggérant une gestion de stock par seuil ou une commande basée sur un conditionnement logistique fixe (type palette ou couche). La commande intervient ici 8 jours après la précédente (le 03/11), s'inscrivant parfaitement dans le cycle habituel.
...
| [LV143] LV Mayonnaise (huile 70%) 200 ml  | 8 | Stock prédit: -0.9u (-3j restants) → prédit 8u mais non commandé |
...
| [LV145] LV Sauce Tartare 200 ml  | 9 | Stock prédit: -1.5u (-5j restants) → prédit 9u mais non commandé |
...
| [LV132] LV Tartinade Houmous type 190g | 78 | Stock prédit: 5.2u (3j restants) → prédit 78u mais non commandé |
...
*Rapport généré automatiquement le 2025-12-18T11:39:34.663Z*
