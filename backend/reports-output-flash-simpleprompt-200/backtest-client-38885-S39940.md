...
- **Appels**: 8
- **Tokens**: 7,591 input + 2,262 output = 9,853 total
...
- **Saisonnalité**: weak
- **Tendance**: Stable mais très faible rotation (approx. 2u/commande)
- **Outliers détectés**: Aucun

**🧠 Raisonnement LLM:**
Le produit présente une demande très faible et irrégulière. L'historique montre que les commandes sont quasi systématiquement comprises entre 1 et 3 unités. La dernière commande datant d'il y a 2 mois (28 août), le stock client est probablement à renouveler. En se basant sur la moyenne historique (2u) et la dernière commande reçue (2u), la quantité de 2 unités est la plus probable. La date demandée (Lundi) correspond aux habitudes d'achat constatées en N-1 pour cette période de l'année (septembre/octobre).
...
| [TVF004] TVF TARTINADE BIO OLIVE 180g | 0 | Stock prédit: 0.0u (3j restants) → prédit 0u mais non commandé |
...
*Rapport généré automatiquement le 2025-12-18T11:40:11.465Z*
