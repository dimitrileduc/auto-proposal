...
|---------|-------------|--------|
| [PF0609] YVALLI SAUCE TOMATE 2,5 KG | 6 | Stock prédit: -2.8u (-18j restants) → prédit 6u mais non commandé |
...
|---------|---------------|--------|
| [PF0539] JF VOL AU VENT 2,5 KG | 4 | Jamais commandé avant dans les 120j précédents (pas d'historique) |


---

*Rapport généré automatiquement le 2025-11-18T14:38:43.380Z*
