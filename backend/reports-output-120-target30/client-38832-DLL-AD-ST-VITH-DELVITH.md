...
- **Stratégie**: median_recent_orders
- **Confiance**: high
- **Quantités historiques**: [2, 5, 3, 2, 4]
- **Nombre commandes**: 11
- **Valeur médiane**: 3
...
- **Stratégie**: median_recent_orders
- **Confiance**: high
- **Quantités historiques**: [2, 2, 5, 3, 4]
- **Nombre commandes**: 13
- **Valeur médiane**: 3
