...
|----------|---------|---------|----------------|
| **Recall** | 75.2% | 79.3% | % de besoins réels détectés |
| **Precision** | 46.9% | 50.0% | % de prédictions correctes (50.0% proposés non commandés) |
| **F1-Score** | 52.7% | 59.3% | Équilibre détection/précision |
| **wMAPE** | 43.5% | 39.7% | ⚖️ Écart pondéré robuste (métrique principale) |
| **MAPE** | 46.0% | 41.6% | Écart moyen (info, biaisé) |
| **Bias** | -8.8% | -6.1% | Biais directionnel (>0 = surestime, <0 = sous-estime) |
...
**Comment se répartissent les 90 clients ?**
...
*Rapport généré automatiquement le 2025-12-18T20:02:07.712Z*
