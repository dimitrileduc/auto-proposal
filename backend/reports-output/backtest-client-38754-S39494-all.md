...
| **F1-Score** | 68.7% | Score équilibré global |
...
| Métrique | Valeur | Interprétation |
|----------|--------|----------------|
| **MAE** | 0.26 unités | Erreur moyenne absolue (métrique principale) |
| **MAPE** | 17.4% | Erreur moyenne en % (complémentaire) |
...
|---------|-------------|--------|
| [JF036] JF MITRAILLETTE SQUEEZE 300ML | 1 | Stock prédit: 0.2u (18j restants) → prédit 1u mais non commandé |
| [JF014] JF SAUCE BEARNAISE 470ML WECK | 1 | Stock prédit: -0.0u (-2j restants) → prédit 1u mais non commandé |
| [JF008] JF MAYONNA DU CHEF 470 ML WECK | 1 | Stock prédit: -0.0u (-2j restants) → prédit 1u mais non commandé |
...
*Rapport généré automatiquement le 2025-11-15T09:48:30.205Z*
