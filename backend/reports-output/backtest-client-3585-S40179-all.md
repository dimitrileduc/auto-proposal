...
| Métrique | Valeur | Interprétation |
|----------|--------|----------------|
| **MAE** | 68.33 unités | Erreur moyenne absolue (symétrique) |
| **wMAPE** | 61.9% | ⚖️ Erreur pondérée robuste (métrique principale) |
| **MAPE** | 41.5% | Erreur moyenne en % (biaisé, pour info) |
| **Bias** | -59.5% | Biais directionnel (>0 = surestime, <0 = sous-estime) |
...
*Rapport généré automatiquement le 2025-12-18T20:00:41.236Z*
