...
| Métrique | Valeur | Interprétation |
|----------|--------|----------------|
| **MAE** | 4.17 unités | Erreur moyenne absolue (symétrique) |
| **wMAPE** | 78.1% | ⚖️ Erreur pondérée robuste (métrique principale) |
| **MAPE** | 79.0% | Erreur moyenne en % (biaisé, pour info) |
| **Bias** | -78.1% | Biais directionnel (>0 = surestime, <0 = sous-estime) |
...
*Rapport généré automatiquement le 2025-12-18T20:00:33.900Z*
