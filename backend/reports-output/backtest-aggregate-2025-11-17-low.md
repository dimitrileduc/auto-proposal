...
|----------|---------|---------|----------------|
| **Recall** | 3.7% | 0.0% | % de besoins réels détectés |
| **Precision** | 10.6% | 0.0% | % de prédictions correctes (100.0% proposés non commandés) |
| **F1-Score** | 4.2% | 0.0% | Équilibre détection/précision |
| **MAPE** | 6.0% | 0.0% | Écart moyen sur les quantités prédites |
...
*Rapport généré automatiquement le 2025-11-17T12:04:39.907Z*
