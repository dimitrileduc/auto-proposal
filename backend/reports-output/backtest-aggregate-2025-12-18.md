...
- **Date d'exécution** : 18/12/2025 21:02:07
- **Clients analysés** : 195
- **Clients réussis** : 85
- **Clients échoués** : 110
...
|----------|---------|---------|----------------|
| **Recall** | 89.4% | 100.0% | % de besoins réels détectés |
| **Precision** | 50.7% | 50.0% | % de prédictions correctes (50.0% proposés non commandés) |
| **F1-Score** | 59.6% | 66.7% | Équilibre détection/précision |
| **wMAPE** | 45.8% | 41.7% | ⚖️ Écart pondéré robuste (métrique principale) |
| **MAPE** | 48.4% | 43.8% | Écart moyen (info, biaisé) |
| **Bias** | -9.9% | -10.5% | Biais directionnel (>0 = surestime, <0 = sous-estime) |
...
|----------|--------|----------------|
| **Appels LLM** | 1349 | Nombre de produits prédits par LLM (>2 commandes historiques) |
| **Tokens Total** | 4 154 597 | 1 687 052 prompt + 2 467 545 completion |
| **Tokens Moyen/Appel** | 3 080 | Tokens moyen par prédiction LLM |
...
**Comment se répartissent les 85 clients ?**
...
*Rapport généré automatiquement le 2025-12-18T20:02:07.709Z*
