...
| **Precision** | 56.8% | 50.0% | % de prédictions correctes (50.0% proposés non commandés) |
| **F1-Score** | 67.7% | 66.7% | Équilibre détection/précision |
| **wMAPE** | 51.7% | 0.0% | ⚖️ Écart pondéré robuste (métrique principale) |
| **MAPE** | 53.2% | 0.0% | Écart moyen (info, biaisé) |
| **Bias** | 42.6% | 0.0% | Biais directionnel (>0 = surestime, <0 = sous-estime) |
...
**Comment se répartissent les 11 clients ?**
...
*Rapport généré automatiquement le 2025-12-18T20:02:07.710Z*
