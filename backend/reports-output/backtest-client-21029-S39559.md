...
|----------|--------|----------------|
| **Précision** | 80.0% | 30 produits prédits, 24 corrects |
| **Rappel** | 92.3% | 26 produits réels, 24 détectés |
...
| Métrique | Valeur | Interprétation |
|----------|--------|----------------|
| **MAE** | 0.54 unités | Erreur moyenne absolue (métrique principale) |
...
*Rapport généré automatiquement le 2025-11-18T20:06:47.324Z*
