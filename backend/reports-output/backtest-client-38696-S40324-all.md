...
- **Appels**: 42
- **Tokens**: 54,337 input + 75,998 output = 130,335 total
...
|----------|--------|----------------|
| **Précision** | 7.8% | 51 produits prédits, 4 corrects |
| **Rappel** | 40.0% | 10 produits réels, 4 détectés |
| **F1-Score** | 13.1% | Score équilibré global |
...
**🔍 Analyse LLM:**
- **Pattern temporel**: Irrégulier, cycle médian observé entre 22 et 45 jours
- **Saisonnalité**: weak
- **Tendance**: Stable à faible volume (1-2u)
- **Outliers détectés**: 6u

**🧠 Raisonnement LLM:**
L'analyse montre un produit à rotation lente avec des commandes de petites quantités (majoritairement 2u). Un pic de 6u en avril 2024 a été écarté comme outlier. La saisonnalité est faiblement marquée, bien qu'une activité plus régulière soit notée en été. Sur le plan récent, une commande a eu lieu le 21 octobre (1u), précédée d'une autre le 29 septembre (2u), soit un intervalle de 22 jours. Au 12 novembre, 22 jours se sont déjà écoulés depuis la dernière commande. Selon le cycle historique récent, une commande est hautement probable dans la fenêtre des 30 prochains jours (probablement entre le 15 et le 25 novembre). Le volume recommandé se base sur la part prédominante de l'historique (mode à 2u) malgré le dernier retrait à 1u.
...
**🔍 Analyse LLM:**
- **Pattern temporel**: Cycle irrégulier avec une médiane de 20 à 25 jours (min 7j, max 40j)
- **Saisonnalité**: weak
- **Tendance**: Instable - Phase de réapprovisionnement attendue après 50 jours d'inactivité
- **Outliers détectés**: 10u, 10u

**🧠 Raisonnement LLM:**
L'analyse montre un produit au rythme de commande erratique mais récurrent. Après avoir retiré les pics de 10 unités (avril 2024 et septembre 2025) qui semblent correspondre à des stockages de précaution ou des événements spécifiques, la demande de fond se situe autour de 3 unités. La dernière commande date du 23 septembre 2025 (soit il y a 50 jours), ce qui dépasse largement le cycle moyen de 20-25 jours identifié en 2024. Le client est donc en rupture probable ou en besoin immédiat de réapprovisionnement. Compte tenu de l'approche de la période festive de fin d'année (favorable à la sauce Béarnaise) et du retard de commande, on prévoit une commande de 4 unités (légèrement au-dessus de la base de 3) dans les 30 prochains jours. Une seule commande est prévue malgré le délai car le volume de septembre (10u) suggère une capacité de stockage permettant d'espacer les achats.
...
| [JF001] JF MAYONNAI TRUFFES 250ML WECK | 6 | Stock prédit: -2.2u (-7j restants) → prédit 6u mais non commandé |
...
| [JF056] JF SAUCE CHIPOTLE 250ML WECK | 2 | Stock prédit: 0.8u (13j restants) → prédit 2u mais non commandé |
...
*Rapport généré automatiquement le 2025-12-18T19:55:11.607Z*
