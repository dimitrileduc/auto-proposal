...
- **Date d'exécution** : 18/12/2025 11:36:46
- **Clients analysés** : 48
- **Clients réussis** : 48
- **Clients échoués** : 0
...
| **wMAPE** | 32.3% | 29.7% | ⚖️ Écart pondéré robuste (métrique principale) |
| **MAPE** | 36.6% | 33.3% | Écart moyen (info, biaisé) |
| **Bias** | 4.7% | 0.0% | Biais directionnel (>0 = surestime, <0 = sous-estime) |
...
| **Tokens Total** | 956 253 | 730 914 prompt + 225 339 completion |
| **Tokens Moyen/Appel** | 1 116 | Tokens moyen par prédiction LLM |
...
*Rapport généré automatiquement le 2025-12-18T10:36:46.141Z*
