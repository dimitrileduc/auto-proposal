...
| Métrique | Valeur | Interprétation |
|----------|--------|----------------|
| **MAE** | 37.00 unités | Erreur moyenne absolue (symétrique) |
| **wMAPE** | 49.6% | ⚖️ Erreur pondérée robuste (métrique principale) |
| **MAPE** | 49.4% | Erreur moyenne en % (biaisé, pour info) |
| **Bias** | -49.6% | Biais directionnel (>0 = surestime, <0 = sous-estime) |
...
*Rapport généré automatiquement le 2025-12-18T10:36:37.544Z*
