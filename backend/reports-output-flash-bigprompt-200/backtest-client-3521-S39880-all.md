...
- **Appels**: 2
- **Tokens**: 3,245 input + 595 output = 3,840 total
...
- **Saisonnalité**: none
- **Tendance**: Baisse progressive -15% (de 52u à 44u)
- **Outliers détectés**: 75u, 20u

**🧠 Raisonnement LLM:**
L'historique montre une transition nette d'un volume standard de 52u (dominant en 2024) vers un nouveau palier de 44u observé sur les deux derniers mois (septembre et octobre 2025). Le cycle de commande est d'environ 20 à 30 jours. La dernière commande date du 08/10 (mercredi), la prédiction pour le 21/10 (mardi) est cohérente avec le rythme de commande en milieu de semaine. Le pic de 75u en août est considéré comme un outlier (stock de sécurité ou promotion) car non reconduit. Le volume de 44u reflète la demande réelle actuelle la plus probable.
...
| [PF0097] FILOU MOUTARDE 5 KG | 3 | Stock prédit: -0.6u (-43j restants) → prédit 3u mais non commandé |
...
*Rapport généré automatiquement le 2025-12-18T11:14:59.316Z*
