...
| Métrique | Valeur | Interprétation |
|----------|--------|----------------|
| **MAE** | 141.00 unités | Erreur moyenne absolue (symétrique) |
...
|---------|--------|------|-----------|----------|------|------------|------------|--------|
| [PF0165] FILOU COCKTAIL FRENKEN 3 L | 246 | 387 | 141.0 | 36.4% | ✅ partial | ❌ Non | ❌ Non | 📊 Médiane |
...
*Rapport généré automatiquement le 2025-12-18T11:18:25.251Z*
