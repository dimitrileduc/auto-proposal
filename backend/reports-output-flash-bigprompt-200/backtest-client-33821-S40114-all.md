...
- **Appels**: 2
- **Tokens**: 3,073 input + 584 output = 3,657 total
...
|---------|--------|------|-----------|----------|------|------------|------------|--------|
| [PF0516] YVALLI PROVENCALE 2,5 KG BOC | 10 | 10 | 0.0 | 0.0% | 🎯 exact | ✅ Oui | ✅ Oui | 🤖 LLM |
...
<details>
<summary><strong>1. [PF0516] YVALLI PROVENCALE 2,5 KG BOC</strong> - LLM: 10u vs Médiane: 12u (Réel: 10u)</summary>
...
**🧠 Raisonnement LLM:**
L'historique montre une tendance à la baisse constante sur les volumes récents (20u en août, 11u en septembre, 10u en octobre). La date du 2025-11-04 respecte l'intervalle d'environ un mois constaté sur les trois dernières commandes. Le pic de 20u observé en août 2025 et en mars 2024 semble exceptionnel face à la stabilisation actuelle autour de 10-11u. Je privilégie la dernière valeur connue (10u) pour minimiser l'erreur, la tendance étant à la stabilisation sur ce volume de fond.
...
*Rapport généré automatiquement le 2025-12-18T11:17:30.529Z*
