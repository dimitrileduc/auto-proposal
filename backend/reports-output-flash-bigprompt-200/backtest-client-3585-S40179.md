...
| Métrique | Valeur | Interprétation |
|----------|--------|----------------|
| **MAE** | 68.40 unités | Erreur moyenne absolue (symétrique) |
| **wMAPE** | 55.3% | ⚖️ Erreur pondérée robuste (métrique principale) |
| **MAPE** | 39.6% | Erreur moyenne en % (biaisé, pour info) |
| **Bias** | -50.2% | Biais directionnel (>0 = surestime, <0 = sous-estime) |
...
*Rapport généré automatiquement le 2025-12-18T11:15:22.120Z*
