...
- **Appels**: 1
- **Tokens**: 1,442 input + 294 output = 1,736 total
...
|---------|--------|------|-----------|----------|------|------------|------------|--------|
| [MATE01] MATE MATE thé glacé bio pétillant au yerba maté verre 330ml | 36 | 18 | 18.0 | 100.0% | ✅ partial | ✅ Oui | ✅ Oui | 🤖 LLM |
...
<details>
<summary><strong>1. [MATE01] MATE MATE thé glacé bio pétillant au yerba maté verre 330ml</strong> - LLM: 36u vs Médiane: 36u (Réel: 18u)</summary>

**Quantités:**
- 🤖 **LLM prédit**: 36u (confidence: low)
- 📊 **Baseline N-1**: 36u
- 📊 **Médiane**: 36u
- ✅ **Réel commandé**: 18u
...
**🧠 Raisonnement LLM:**
L'historique est limité à deux points de données montrant une fréquence mensuelle (intervalle de 24 jours). La dernière commande date du 25 juillet (36u), soit environ 45 jours avant la date de prédiction (8 septembre). Le client a sauté le mois d'août ou commande selon un cycle de reconstitution de stock plus long. En suivant la règle du jour hors cycle, on prévoit la quantité du prochain passage probable. Bien que la tendance entre les deux points soit à la baisse (45u vers 36u), la valeur de 36u (conditionnement standard probable pour ce type de boisson en verre) constitue la base de référence la plus fiable pour la prochaine commande.
...
**✅ Quantité LLM**: 36u (confidence: low)
**📊 Quantité Réelle**: 18u
...
*Rapport généré automatiquement le 2025-12-18T11:16:57.811Z*
