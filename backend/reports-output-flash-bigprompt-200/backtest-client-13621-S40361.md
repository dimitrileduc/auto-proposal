...
- **Appels**: 119
- **Tokens**: 182,019 input + 39,047 output = 221,066 total
...
**🔍 Analyse LLM:**
- **Pattern temporel**: Hebdomadaire (7j) identifié sur les jeudis en octobre
- **Saisonnalité**: none
- **Tendance**: Instabilité forte avec baisse récente
- **Outliers détectés**: 50u, 1u

**🧠 Raisonnement LLM:**
L'analyse montre deux phases : un cycle de jeudi en mi-octobre suivi d'un glissement vers le mercredi fin octobre/novembre. La commande du 12/11 (hier) à 1u semble être un ajustement ou un reliquat, tandis que le 50u du 16/10 est un outlier massif non reproduit. En excluant les extrêmes (50u et 1u), les volumes médians se situent autour de 5-7u. Étant donné la commande très faible de 1u hier, une commande de réapprovisionnement de fond de rayon est attendue ce jeudi pour compenser le faible volume de la veille, en s'alignant sur la valeur cohérente de 7u pondérée par la baisse récente, soit 5u.
...
| [PF1810] LV SAUCE BEARNAISE 250ML WECK | 200 | Stock prédit: -345.9u (-18j restants) → prédit 200u mais non commandé |
...
| [PF1557] LV TARTINADE BIO AUBERGINE 200 | 2330 | Stock prédit: 144.6u (5j restants) → prédit 2330u mais non commandé |
| [PF2980] LV TARTINADE BIO AIL OURS200ML | 816 | Stock prédit: -600.5u (-30j restants) → prédit 816u mais non commandé |
| [PF1768] LV TARTINADE BIO TRUFFES 135G | 525 | Stock prédit: 85.1u (15j restants) → prédit 525u mais non commandé |
...
| [PI3072] PI TARTI POIS CHICHES BIO CONS 250G  | 5400 | Stock prédit: 143.6u (2j restants) → prédit 5400u mais non commandé |
...
*Rapport généré automatiquement le 2025-12-18T11:12:34.052Z*
