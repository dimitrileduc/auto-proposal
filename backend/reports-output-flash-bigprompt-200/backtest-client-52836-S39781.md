...
| **wMAPE** | 72.0% | ⚖️ Erreur pondérée robuste (métrique principale) |
| **MAPE** | 74.2% | Erreur moyenne en % (biaisé, pour info) |
| **Bias** | -56.0% | Biais directionnel (>0 = surestime, <0 = sous-estime) |
...
*Rapport généré automatiquement le 2025-12-18T11:19:46.744Z*
