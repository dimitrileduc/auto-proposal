...
- **Date d'exécution** : 18/12/2025 12:20:14
...
| **wMAPE** | 43.5% | 36.4% | ⚖️ Écart pondéré robuste (métrique principale) |
| **MAPE** | 45.6% | 40.0% | Écart moyen (info, biaisé) |
| **Bias** | -4.7% | -4.5% | Biais directionnel (>0 = surestime, <0 = sous-estime) |
...
|----------|--------|----------------|
| **Appels LLM** | 2450 | Nombre de produits prédits par LLM (>2 commandes historiques) |
| **Tokens Total** | 4 421 173 | 3 709 303 prompt + 711 870 completion |
| **Tokens Moyen/Appel** | 1 805 | Tokens moyen par prédiction LLM |
...
*Rapport généré automatiquement le 2025-12-18T11:20:14.105Z*
