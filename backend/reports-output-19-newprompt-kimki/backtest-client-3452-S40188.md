...
- **Appels**: 4
- **Tokens**: 8,968 input + 20,359 output = 29,327 total
...
**🔍 Analyse LLM:**
- **Pattern temporel**: Commande erratique avec intervalles irréguliers (7j, 35j, 14j, 7j)
- **Saisonnalité**: none
- **Tendance**: stable
- **Outliers détectés**: Aucun

**🧠 Raisonnement LLM:**
Cycle médian de 10.5 jours (CV 72.9% - erratique). Prochaine commande prévue dans 7 jours (13/11). Quantité médiane stable à 98u (5/5 points identiques, CV 0%). Pas de saisonnalité détectable.
...
**🔍 Analyse LLM:**
- **Pattern temporel**: cycle median de 14 jours (intervalles: 7j,14j,14j,21j, CV=35%)
- **Saisonnalité**: none
- **Tendance**: stable
- **Outliers détectés**: 780u

**🧠 Raisonnement LLM:**
Cycle de 14 jours detecte (CV=35% confiance:medium). Prochaine commande dans 11 jours le 2025-11-17. Outlier 780u isole exclu. Baseline calculee par moyenne tronquee sur [130,130,130,390] donnant 130u. Pattern stable 130/390u sans saisonnalite forte (impact:none). Confiance faible quantite (CV=57%, 4 points ret
...
**✅ Quantité LLM**: 130u (confidence: low)
...
| [PF3316] DLL VINAIGRETTE FINES HERBES PET 450ML | 96 | Stock prédit: 44.2u (1j restants) → prédit 96u mais non commandé |
...
*Rapport généré automatiquement le 2025-12-19T07:27:21.757Z*
