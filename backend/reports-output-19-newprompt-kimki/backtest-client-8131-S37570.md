...
- **Appels**: 8
- **Tokens**: 16,829 input + 35,439 output = 52,268 total
...
| Métrique | Valeur | Interprétation |
|----------|--------|----------------|
| **MAE** | 145.00 unités | Erreur moyenne absolue (symétrique) |
...
**🔍 Analyse LLM:**
- **Pattern temporel**: Commande irrégulière avec intervalles variables (3j, 7j, 11j), médiane de 7j
- **Saisonnalité**: none
- **Tendance**: stable
- **Outliers détectés**: 240u

**🧠 Raisonnement LLM:**
Cycle de 7j détecté mais erratique (CV=40.4%), prochaine commande dans 1 jour. Quantité médiane de 160u après exclusion de l'outlier 240u (commande exceptionnelle isolée). Confiance faible sur le timing, moyenne sur la quantité.
...
**🔍 Analyse LLM:**
- **Pattern temporel**: Commandes irrégulières avec intervalles variables (7, 7, 18, 10 jours), cycle médian de 8.5 jours mais fort taux de variation (CV=42.86%)
- **Saisonnalité**: none
- **Tendance**: stable
- **Outliers détectés**: 80u

**🧠 Raisonnement LLM:**
Cycle de 8.5 jours détecté (médiane des intervalles: 7,7,18,10). Prochaine commande prévue le 2025-06-21, soit dans 2 jours. Quantité médiane de 22u calculée après exclusion de l'outlier 80u et application d'une moyenne tronquée. Confiance faible due à la forte variabilité du cycle et des quantités.
...
**🔍 Analyse LLM:**
- **Pattern temporel**: Cycle erratique de 14 jours médian (CV=51.66%), intervalles variables 7-28j
- **Saisonnalité**: none
- **Tendance**: stable
- **Outliers détectés**: 60u, 3u

**🧠 Raisonnement LLM:**
Cycle de réapprovisionnement médian de 14 jours (CV élevé 51.66% → confiance faible). Prochaine commande prévue le 27 juin 2025 (dans 8 jours → risque confirmé). Quantité médiane de 5u calculée après exclusion des outliers 60u (commande exceptionnelle) et 3u (valeur basse isolée). Pas de données saisonnières N-1. Historique stable autour de 5u sur les 3 dernières commandes.
...
**🔍 Analyse LLM:**
- **Pattern temporel**: Commande tous les 19 jours en moyenne avec une variabilité modérée (CV=33%)
- **Saisonnalité**: none
- **Tendance**: stable
- **Outliers détectés**: Aucun

**🧠 Raisonnement LLM:**
Cycle de 19 jours détecté (médiane des intervalles: 14, 24, 25, 11 jours, CV=33%), prochaine commande prévue dans 3 jours (2025-06-22). Toutes les commandes historiques sont de 52 unités (consistance parfaite, aucun outlier détecté). Quantité recommandée = médiane = 52u. Données N-1 absentes, pas d'ajustement saisonnier.
...
**🔍 Analyse LLM:**
- **Pattern temporel**: Commandes irrégulières avec intervalles de 4j et 21j (médiane 12.5j, CV 68%)
- **Saisonnalité**: none
- **Tendance**: stable
- **Outliers détectés**: 26u

**🧠 Raisonnement LLM:**
Cycle erratique (CV 68%) avec médiane 12.5j entre commandes. Dernière commande le 23 mai 2025 suggère une prochaine commande attendue le 5 juin (déjà 14j de retard), risque de rupture IMMÉDIAT. Analyse des quantités [52,26,52] : la valeur 26u est un pic isolé non récurrent, exclue comme outlier. Les valeurs typiques [52,52] donnent une médiane stable de 52u. Pas de données N-1 pour saisonnalité.
...
*Rapport généré automatiquement le 2025-12-19T07:31:24.430Z*
