...
|----------|---------|---------|----------------|
| **Recall** | 69.2% | 83.3% | % de besoins réels détectés |
| **Precision** | 41.6% | 50.0% | % de prédictions correctes (50.0% proposés non commandés) |
| **F1-Score** | 45.5% | 58.5% | Équilibre détection/précision |
| **wMAPE** | 36.9% | 23.4% | ⚖️ Écart pondéré robuste (métrique principale) |
| **MAPE** | 39.7% | 26.7% | Écart moyen (info, biaisé) |
| **Bias** | -0.4% | 0.0% | Biais directionnel (>0 = surestime, <0 = sous-estime) |
...
**Comment se répartissent les 27 clients ?**
...
*Rapport généré automatiquement le 2025-12-19T07:44:07.080Z*
