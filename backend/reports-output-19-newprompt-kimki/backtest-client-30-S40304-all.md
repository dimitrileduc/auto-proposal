...
- **Appels**: 35
- **Tokens**: 76,161 input + 190,250 output = 266,411 total
...
**🔍 Analyse LLM:**
- **Pattern temporel**: Commande irrégulière avec intervalle médian de 12 jours (CV=51.6% - cycle erratique)
- **Saisonnalité**: strong
- **Tendance**: decreasing
- **Outliers détectés**: Aucun

**🧠 Raisonnement LLM:**
Cycle médian de 12 jours calculé sur N-1 (11 intervalles: médiane=12j, CV=51.6% → confiance faible). Dernière commande le 2025-10-02, 41 jours écoulés (3.42 cycles). Prochaine commande prévue au 4ème cycle le 2025-11-19 (dans 7 jours). Quantités N-1: [1,1,1,1,1,1,2,2,3,3,4,5] (CV=63.4%) → méthode 'dernière valeur non-outlier' = 1u. Impact saisonnel fort (N-1 vs récent -50%) mais ajustement non applicable selon règles.
...
**🔍 Analyse LLM:**
- **Pattern temporel**: Historique récent insuffisant (seulement 1 intervalle valide: 37 jours). Analyse basée sur N-1: intervalles [7, 38, 148] jours, médiane 38j, CV 94% (très erratique).
- **Saisonnalité**: none
- **Tendance**: stable
- **Outliers détectés**: Aucun

**🧠 Raisonnement LLM:**
Phase 1: Cycle très variable (CV 94%) => low confiance. Prochaine commande attendue le 2025-11-10, déjà en retard de 2j => RISQUE OUI. Phase 2: Quantités ultra-stables [1,1,1,1,1,1,1], médiane=1u, aucun outlier, CV 0% => high confiance. Seasonality none (pattern temporel différent N-1/récent). Commande: 1u.
...
| [LV160] LV Tartinade Aubergine 190g | 5 | Stock prédit: -6.0u (-20j restants) → prédit 5u mais non commandé |
...
| [LV162] LV Tartinade Tomato Basilico 190g | 5 | Stock prédit: -6.0u (-20j restants) → prédit 5u mais non commandé |
...
| [LV332] LV Tartinade Olive Caper Tomato 190g | 3 | Stock prédit: -2.0u (-20j restants) → prédit 3u mais non commandé |
...
| [JF020] JF SAUCE AIOLI 250ML WECK | 2 | Stock prédit: -3.0u (-20j restants) → prédit 2u mais non commandé |
...
*Rapport généré automatiquement le 2025-12-19T07:28:57.441Z*
