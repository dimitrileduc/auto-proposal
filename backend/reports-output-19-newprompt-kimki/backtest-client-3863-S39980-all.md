...
- **Appels**: 4
- **Tokens**: 9,131 input + 23,846 output = 32,977 total
...
**🔍 Analyse LLM:**
- **Pattern temporel**: Cycle médian de 14j mais intervalle récent très court de 5j (irrégularité)
- **Saisonnalité**: none
- **Tendance**: decreasing
- **Outliers détectés**: Aucun

**🧠 Raisonnement LLM:**
Cycle de 14j détecté (CV=38.6%) mais irrégulier (dernier intervalle 5j). Prochaine commande attendue le 2025-10-27 (déjà -1 jour de retard). Quantité baseline=24u via moyenne tronquée (CV=47.4% sur valeurs récentes [16,16,32,48]). Tendance décroissante forte (48→32→16→16). Saisonnalité non significative (différence -34% vs N-1).
...
**🔍 Analyse LLM:**
- **Pattern temporel**: Commande erratique: intervalles de 5j puis 14j (médiane 9,5j, CV 47%)
- **Saisonnalité**: none
- **Tendance**: stable
- **Outliers détectés**: Aucun

**🧠 Raisonnement LLM:**
Cycle très irrégulier (CV=47%) avec déjà 6 jours de retard vs prédiction (9,5j median). Quantité ultra-stable à 16u sans outlier. Risque immédiat car commande attendue depuis le 22 octobre.
...
|---------|-------------|--------|
| [MF0044] MF Brotaufstrich Kichererbsen - Kreuzkümmel 250g | 40 | Stock prédit: 21.2u (11j restants) → prédit 40u mais non commandé |
...
*Rapport généré automatiquement le 2025-12-19T07:30:42.161Z*
