...
- **Date d'exécution** : 19/12/2025 08:44:07
- **Clients analysés** : 47
- **Clients réussis** : 26
- **Clients échoués** : 21
...
|----------|---------|---------|----------------|
| **Recall** | 83.1% | 100.0% | % de besoins réels détectés |
| **Precision** | 43.1% | 50.0% | % de prédictions correctes (50.0% proposés non commandés) |
| **F1-Score** | 50.8% | 66.7% | Équilibre détection/précision |
| **wMAPE** | 38.4% | 29.1% | ⚖️ Écart pondéré robuste (métrique principale) |
| **MAPE** | 41.3% | 30.5% | Écart moyen (info, biaisé) |
| **Bias** | -0.3% | 0.0% | Biais directionnel (>0 = surestime, <0 = sous-estime) |
...
|----------|--------|----------------|
| **Appels LLM** | 707 | Nombre de produits prédits par LLM (>2 commandes historiques) |
| **Tokens Total** | 4 973 024 | 1 509 374 prompt + 3 463 650 completion |
| **Tokens Moyen/Appel** | 7 034 | Tokens moyen par prédiction LLM |
...
**Comment se répartissent les 26 clients ?**
...
*Rapport généré automatiquement le 2025-12-19T07:44:07.073Z*
