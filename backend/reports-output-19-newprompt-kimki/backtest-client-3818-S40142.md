...
- **Appels**: 4
- **Tokens**: 9,090 input + 23,869 output = 32,959 total
...
**🔍 Analyse LLM:**
- **Pattern temporel**: Historique très stable à 32u avec cycle médian de 16.5j (CV 15.15%) mais dépassement de 6j détecté - prochaine commande attendue immédiatement
- **Saisonnalité**: none
- **Tendance**: stable
- **Outliers détectés**: 48u

**🧠 Raisonnement LLM:**
Cycle de 16.5j détecté (intervalles: 14j,19j, CV=15.15%). Dernière commande 2025-10-13, date prévue 2025-10-29 dépassée de 6j → risque immédiat. Valeur 48u exclue comme outlier isolé. Quantité médiane des 14 valeurs stables = 32u. Pas de saisonnalité forte identifiée. Confidence medium: cycle régulier (high p1) mais seulement 3 points récents (medium p2).
...
**🔍 Analyse LLM:**
- **Pattern temporel**: Commandes irrégulières (intervalles: 7j,14j,21j, CV=40.8%)
- **Saisonnalité**: none
- **Tendance**: stable
- **Outliers détectés**: 80u

**🧠 Raisonnement LLM:**
Cycle médian de 14j très erratique (CV=40.8%). Prochaine commande prévue le 2025-11-05 (dans 1 jour). Quantité typique de 32u après exclusion du pic isolé de 80u. Pas de saisonnalité fiable détectée entre N-1 et récent.
...
|---------|-------------|--------|
| [MF0048] MF Delikatess Mayonnaise 250ml DE | 21 | Stock prédit: 7.4u (6j restants) → prédit 21u mais non commandé |
...
|---------|---------------|--------|
| [MF0062] ​MF Tarti Betterave rouge | 32 | En rupture (-27j) mais non prédit - probablement filtré (pas de consommation ou historique insuffisant) |


---

*Rapport généré automatiquement le 2025-12-19T07:29:48.398Z*
