...
- **Appels**: 14
- **Tokens**: 30,969 input + 81,704 output = 112,673 total
...
**Quantités:**
- 🤖 **LLM prédit**: 112u (confidence: low)
- 📊 **Baseline N-1**: 112u
- 📊 **Médiane**: 112u
- ✅ **Réel commandé**: 112u
- 📉 **Erreur LLM**: 0u (0.0%)
...
**🔍 Analyse LLM:**
- **Pattern temporel**: Commande irrégulière avec médiane 21j (CV 46.5%)
- **Saisonnalité**: none
- **Tendance**: stable
- **Outliers détectés**: Aucun

**🧠 Raisonnement LLM:**
Cycle médian de 21j détecté (CV=46.5% - erratique). Prochaine commande prévue dans 10j (21 nov). Quantité stable médiane 112u sur 4 commandes (aucun outlier). Pas de saisonnalité N-1. Quantité recommandée: 112u.
...
**✅ Quantité LLM**: 112u (confidence: low)
...
|---------|-------------|--------|
| [PF01012] CARREFOUR VOL AU VENT 400 GR | 160 | Stock prédit: -36.3u (-1j restants) → prédit 160u mais non commandé |
...
| [PF3229] CARREFOUR VOL AU VENT BOCAL 800 GR | 247 | Stock prédit: -11.5u (0j restants) → prédit 247u mais non commandé |
...
*Rapport généré automatiquement le 2025-12-19T07:33:46.474Z*
