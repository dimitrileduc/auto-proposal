...
- **Appels**: 5
- **Tokens**: 11,304 input + 43,291 output = 54,595 total
...
**🔍 Analyse LLM:**
- **Pattern temporel**: Commande tous les 17.6 jours en moyenne (intervalles: 14.6j, 17.0j, 18.3j, 25.1j), CV=20.1%
- **Saisonnalité**: none
- **Tendance**: stable
- **Outliers détectés**: Aucun

**🧠 Raisonnement LLM:**
Cycle de 17.6 jours détecté (CV=20.1% → confiance medium), prochaine commande dans 3.8 jours (2025-10-31). Toutes les quantités récentes sont de 80u, médiane retenue après filtrage outliers (aucun exclu). Pas de saisonnalité claire détectée (pattern N-1 irrégulier). Quantité stable.
...
**🔍 Analyse LLM:**
- **Pattern temporel**: Commande tous les 25j régulièrement
- **Saisonnalité**: none
- **Tendance**: stable
- **Outliers détectés**: Aucun

**🧠 Raisonnement LLM:**
Cycle de 25 jours détecté (CV=9.8%), prochaine commande prévue le 2025-11-08 (dans 11 jours). Quantité moyenne tronquée de 2u après filtrage outliers. Aucune saisonnalité forte détectée (impact none). Tendance stable.
...
**🔍 Analyse LLM:**
- **Pattern temporel**: Cycle erratique de 34 jours (médiane N-1), CV=58.6%
- **Saisonnalité**: none
- **Tendance**: stable
- **Outliers détectés**: 3u

**🧠 Raisonnement LLM:**
Historique récent insuffisant (<3 commandes), utilisation de N-1. Cycle médian de 34 jours très erratique (CV=58.6%). Dernière commande le 25/08/2025, prochaine attendue le 28/09/2025 (déjà passée de 30 jours) → risque immédiat. Quantité moyenne tronquée des données filtrées (excl. outlier isolé 3) = 1.5 → arrondi à 2 unités. Seasonalité non détectée (différence 33% vs N-1, hors seuils). Confiance globale faible due à la volatilité du cycle.
...
*Rapport généré automatiquement le 2025-12-19T07:30:36.691Z*
