...
- **Appels**: 3
- **Tokens**: 6,898 input + 17,514 output = 24,412 total
...
| Métrique | Valeur | Interprétation |
|----------|--------|----------------|
| **MAE** | 30.50 unités | Erreur moyenne absolue (symétrique) |
| **wMAPE** | 34.7% | ⚖️ Erreur pondérée robuste (métrique principale) |
| **MAPE** | 34.3% | Erreur moyenne en % (biaisé, pour info) |
| **Bias** | 34.7% | Biais directionnel (>0 = surestime, <0 = sous-estime) |
...
| [PF2996] ITM BO VIN CIBOULET PET 450 | 152 | 112 | 40.0 | 35.7% | ✅ partial | ✅ Oui | ✅ Oui | 🤖 LLM |
...
**🔍 Analyse LLM:**
- **Pattern temporel**: Cycle irrégulier de 15 jours médian mais très variable (CV 70%)
- **Saisonnalité**: none
- **Tendance**: stable
- **Outliers détectés**: Aucun

**🧠 Raisonnement LLM:**
Cycle médian de 15 jours très erratique (CV 70%). La date de commande prédite (29/10) est déjà dépassée de 6 jours, risque immédiat. Quantité calculée par moyenne tronquée (85u) sur 5 commandes sans outlier détecté, saisonnalité absente.

</details>


<details>
<summary><strong>2. [PF2996] ITM BO VIN CIBOULET PET 450</strong> - LLM: 152u vs Médiane: 224u (Réel: 112u)</summary>

**Quantités:**
- 🤖 **LLM prédit**: 152u (confidence: low)
- 📊 **Baseline N-1**: 152u
- 📊 **Médiane**: 224u
- ✅ **Réel commandé**: 112u
- 📉 **Erreur LLM**: 40u (35.7%)
...
**🔍 Analyse LLM:**
- **Pattern temporel**: Commande erratique (intervalles 1j et 70j, CV=97%)
- **Saisonnalité**: none
- **Tendance**: stable
- **Outliers détectés**: 448u

**🧠 Raisonnement LLM:**
Cycle médian de 35.5j très erratique (CV=97%). Prochaine commande prévue le 2025-11-19 (dans 15j) → RISQUE OUI. Outlier 448u exclu (unique et >Q3+1.5×IQR). Baseline calculée sur 16 valeurs non-outlier (CV=35%): moyenne tronquée = 152u. Pas d'impact saisonnier significatif.
...
**✅ Quantité LLM**: 152u (confidence: low)
...
|---------|-------------|--------|
| [PF2997] ITM BO VIN YOGORETTE PET 450 | 202 | Stock prédit: -67.8u (-9j restants) → prédit 202u mais non commandé |
...
*Rapport généré automatiquement le 2025-12-19T07:28:24.490Z*
