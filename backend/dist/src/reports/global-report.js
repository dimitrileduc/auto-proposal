import { title, separator, table, } from "./formatters";
/**
 * Génère le rapport markdown global pour tous les clients
 */
export function generateGlobalReport(data) {
    const sections = [];
 ...
 */
function generateGlobalStatsTable(data) {
    const sections = [];
 ...
 */
function generateDetailedExamplesList(data) {
    const sections = [];
 ...
 */
function generateAllClientsTable(data) {
    const sections = [];
