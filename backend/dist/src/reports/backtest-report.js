...
|---------|--------|------|-----------|----------|------|
${comparison.truePositives.map(tp => `| ${tp.productName} | ${tp.predictedQty} | ${tp.realQty} | ${tp.absoluteError.toFixed(1)} | ${tp.errorPercent.toFixed(1)}% | ${getMatchTypeEmoji(tp.matchType)} ${tp.matchType} |`).join('\n')}
