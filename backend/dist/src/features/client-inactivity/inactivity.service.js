 ...
 * ```
 */
export async function getInactiveClients(dateMin, dateMax, excludeAutoProposalTagId, excludedPartnerTagId) {
    const partners = await odooClient.getInactiveCompanyPartners(dateMin, dateMax, excludeAutoProposalTagId, excludedPartnerTagId);
