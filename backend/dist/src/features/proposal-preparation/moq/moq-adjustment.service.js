 ...
 */
export function adjustForMinimumOrder(products, currentTotal, minimumOrder) {
    ...
    while (remainingGap > 0 && iterations < maxIterations) {
        ...
        const adjustedProduct = adjustedProducts.find((p) => p.product_id === sortedProduct.product_id);
        // Ajouter +1 unité
