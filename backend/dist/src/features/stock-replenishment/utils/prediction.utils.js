 ...
 */
export function predictStockStatus(product, consumptionPerDay, currentDate = new Date()) {
    ...
    const daysElapsed = Math.floor((currentDate.getTime() - lastOrderDate.getTime()) / (1000 * 60 * 60 * 24));
