 ...
 * ```
 */
export async function getProductOrderHistory(partnerId = autoProposalConfig.testing.defaultClientId, windowDays = autoProposalConfig.analysisWindowDays, referenceDate) {
    const rawHistory = await odooClient.getOrderHistoryByPartner(partnerId, windowDays, referenceDate, autoProposalConfig.testing.includeDraftOrders, autoProposalConfig.productFiltering.excludedCategoryIds);
