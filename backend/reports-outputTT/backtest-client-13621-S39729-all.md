...
- **Appels**: 122
- **Tokens**: 150,062 input + 231,775 output = 381,837 total
...
|----------|--------|----------------|
| **Précision** | 2.5% | 159 produits prédits, 4 corrects |
| **Rappel** | 57.1% | 7 produits réels, 4 détectés |
| **F1-Score** | 4.8% | Score équilibré global |
...
**🧠 Raisonnement LLM:**
L'historique montre une constance parfaite avec trois commandes successives de 200 unités. L'intervalle entre les commandes est très stable, oscillant entre 23 et 25 jours (moyenne de 24 jours). La dernière commande ayant eu lieu le 2025-10-09, la prochaine est statistiquement prévue autour du 2 novembre 2025. Cet événement tombe dans la fenêtre de prédiction de 30 jours. Aucune saisonnalité ou outlier ne venant perturber le signal, la recommandation se base sur la demande de fond observée pour une commande unique.
...
**🔍 Analyse LLM:**
- **Pattern temporel**: Cycle irrégulier d'environ 25 à 30 jours (moyenne 25,5j sur les derniers mois)
- **Saisonnalité**: weak
- **Tendance**: Hausse (+27% vs N-1) puis stabilisation stricte à 434u
- **Outliers détectés**: 700u

**🧠 Raisonnement LLM:**
L'analyse de l'historique montre une évolution de la demande de fond : alors que l'année N-1 se situait autour de 340u par commande, les trois dernières commandes réelles (août, septembre et octobre 2025) sont parfaitement stables à 434u. Un pic à 700u en septembre 2024 a été identifié comme un événement promotionnel ou de stockage et écarté. Le cycle de commande récent varie entre 17 et 34 jours. La dernière commande ayant eu lieu le 9 octobre 2025, la prochaine échéance théorique se situe entre le 3 novembre et le 12 novembre 2025, ce qui correspond à la fin de notre fenêtre de 30 jours. En respectant la consigne de ne prédire que la prochaine commande sans cumuler, la quantité recommandée est de 434 unités.
...
**🔍 Analyse LLM:**
- **Pattern temporel**: Mensuel irrégulier avec intervalle médian de 24 jours
- **Saisonnalité**: weak
- **Tendance**: Stable à 400u
- **Outliers détectés**: 800u, 600u

**🧠 Raisonnement LLM:**
Étape 1: La demande de fond est clairement identifiée à 400u, les volumes de 600u et 800u observés en été 2024 et 2025 sont traités comme des pics saisonniers ou promotionnels (De-eventing). Étape 2: La saisonnalité montre un pic estival mais un retour au calme en octobre (400u le 10/10/2024). Étape 3: La tendance récente confirme une stabilisation à 400u après le pic d'août. Étape 4: La dernière commande date du 10 septembre 2025. Avec un cycle moyen de 20 à 30 jours, le client est actuellement en retard de commande (33 jours d'écart). Une commande est donc imminente dans la fenêtre des 30 prochains jours. En suivant la règle de non-cumul, on recommande la quantité standard de 400u pour cette prochaine livraison unique.
...
| [RIT04] RITCHIE Pamplemousse - verre 275ml | 14 | Stock prédit: 13.1u (24j restants) → prédit 14u mais non commandé |
...
| [PF1629] LV TARTINADE BIO TOMATE 200ML | 1780 | Stock prédit: 781.2u (23j restants) → prédit 1780u mais non commandé |
...
*Rapport généré automatiquement le 2025-12-18T18:55:32.104Z*
