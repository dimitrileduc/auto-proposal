...
- **Date d'exécution** : 18/12/2025 19:57:51
- **Clients analysés** : 47
- **Clients réussis** : 47
- **Clients échoués** : 0
...
|----------|---------|---------|----------------|
| **Recall** | 88.5% | 100.0% | % de besoins réels détectés |
| **Precision** | 45.3% | 50.0% | % de prédictions correctes (50.0% proposés non commandés) |
| **F1-Score** | 56.6% | 60.0% | Équilibre détection/précision |
| **wMAPE** | 36.2% | 31.8% | ⚖️ Écart pondéré robuste (métrique principale) |
| **MAPE** | 41.6% | 36.7% | Écart moyen (info, biaisé) |
| **Bias** | -0.7% | 0.0% | Biais directionnel (>0 = surestime, <0 = sous-estime) |
...
|----------|--------|----------------|
| **Appels LLM** | 845 | Nombre de produits prédits par LLM (>2 commandes historiques) |
| **Tokens Total** | 2 614 054 | 1 059 258 prompt + 1 554 796 completion |
| **Tokens Moyen/Appel** | 3 094 | Tokens moyen par prédiction LLM |
...
*Rapport généré automatiquement le 2025-12-18T18:57:51.359Z*
