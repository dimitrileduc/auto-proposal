...
- **Appels**: 22
- **Tokens**: 29,105 input + 56,796 output = 85,901 total
...
| Métrique | Valeur | Interprétation |
|----------|--------|----------------|
| **MAE** | 106.10 unités | Erreur moyenne absolue (symétrique) |
| **wMAPE** | 24.8% | ⚖️ Erreur pondérée robuste (métrique principale) |
| **MAPE** | 27.4% | Erreur moyenne en % (biaisé, pour info) |
...
|---------|--------|------|-----------|----------|------|------------|------------|--------|
| [LV342] LV Organic Broccoli Spread 190 g | 0 | 310 | 310.0 | 100.0% | ✅ partial | ✅ Oui | ✅ Oui | 🤖 LLM |
...
<details>
<summary><strong>1. [LV342] LV Organic Broccoli Spread 190 g</strong> - LLM: 0u vs Médiane: 275u (Réel: 310u)</summary>
...
- 📊 **Médiane**: 275u
- ✅ **Réel commandé**: 310u
- 📉 **Erreur LLM**: 310u (100.0%)
- 📉 **Erreur Médiane**: 35u (11.3%)

**🔍 Analyse LLM:**
- **Pattern temporel**: Inactif (Cycle de 3j rompu depuis 44 jours)
- **Saisonnalité**: none
- **Tendance**: Absence de flux (Arrêt des commandes depuis fin août)
- **Outliers détectés**: Aucun

**🧠 Raisonnement LLM:**
Étape 1 : Analyse des quantités (155u et 279u) qui suggèrent un volume de stockage important. Étape 2 : Pas de données N-1 disponibles, mais le produit ne montre pas de pic saisonnier récent. Étape 3 : La tendance est au point mort depuis le 29 août. Un seul intervalle de 3 jours a été observé, mais il n'a pas été répété en septembre ni octobre. Étape 4 : L'écart depuis la dernière commande (44 jours) dépasse largement le cycle initialement observé. Selon la règle 'dernière commande + cycle', le client aurait dû commander début septembre. L'absence de réapprovisionnement après l'achat massif de 434 unités en août indique que le client dispose encore de stock ou que le besoin était ponctuel (événement, promotion). Aucune commande n'est donc prévue dans les 30 prochains jours.
...
**🔍 Analyse LLM:**
- **Pattern temporel**: Cycle mensuel (~30-33j) observé en N-1, passé à ~45j+ en 2025
- **Saisonnalité**: weak
- **Tendance**: Baisse de volume (-38%) et ralentissement de la fréquence
- **Outliers détectés**: Aucun

**🧠 Raisonnement LLM:**
ÉTAPE 1: Aucun outlier identifié mais un changement de palier de volume de 100u à 62u. ÉTAPE 2: La saisonnalité N-1 montrait une stabilité mensuelle (rentrée scolaire) qui ne s'est pas répétée à l'identique en 2025. ÉTAPE 3: La tendance récente est à la baisse (-38% en volume) avec une rupture de rythme (pas de commande en septembre). ÉTAPE 4: La dernière commande remontant au 26 août (soit 47 jours), le client est en situation de rupture probable ou de fin de stock. Une commande de réapprovisionnement est prévue dans les prochains jours (fenêtre 30j respectée). La quantité recommandée se base sur le dernier volume observé (62u) plutôt que sur l'historique N-1 pour rester prudent face à la baisse de demande.
...
| [LV145] LV Sauce Tartare 200 ml  | 250 | Stock prédit: 16.6u (3j restants) → prédit 250u mais non commandé |
...
| [LV332] LV Tartinade Olive Caper Tomato 190g | 237 | Stock prédit: 18.4u (3j restants) → prédit 237u mais non commandé |
...
| [LV342] LV Organic Broccoli Spread 190 g | 310 | LLM avait prédit 0 (pas de besoin) avec stock: -17.0u (-2j) mais client a commandé 310u |
| [LV357] LV Tartinade BIO Asperge 190g | 248 | Stock suffisant: 85.4u (46j restants > seuil 30j) |


---

*Rapport généré automatiquement le 2025-12-18T18:54:10.149Z*
