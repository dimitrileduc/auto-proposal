...
- **Appels**: 11
- **Tokens**: 15,688 input + 32,760 output = 48,448 total
...
**🔍 Analyse LLM:**
- **Pattern temporel**: Irrégulier (intervalles 14-34 jours)
- **Saisonnalité**: none
- **Tendance**: stable
- **Outliers détectés**: -60u

**🧠 Raisonnement LLM:**
Le client commande majoritairement 120u par commande (3/4 des cas). La dernière commande du 16/09 était de 120u, confirmant que l'outlier de 60u du 26/08 était exceptionnel. Le cycle irrégulier (~21-22 jours entre commandes récentes) place le 08/10 (mercredi) dans une fenêtre de commande plausible. En agroalimentaire B2B, les ruptures de cycle sont fréquentes mais les quantités standardisées. Privilégier la valeur récurrente (120u) minimise le MAPE mieux qu'une moyenne diluée par un outlier.
...
|---------|-------------|--------|
| [TEN03] TENSAÏ TEA  thé blanc bio à la myrtille 330ml | 55 | Stock prédit: 31.1u (22j restants) → prédit 55u mais non commandé |
...
| [JOY02] JOY! Organic Strawberry Jam 370g | 6 | Stock prédit: -72.2u (-61j restants) → prédit 6u mais non commandé |
| [JOY06] JOY! Organic Rhubarb Jam 370g | 0 | Stock prédit: -20.8u (-46j restants) → prédit 0u mais non commandé |
...
*Rapport généré automatiquement le 2025-12-18T08:49:51.667Z*
