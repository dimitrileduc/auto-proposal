...
- **Appels**: 10
- **Tokens**: 15,960 input + 36,516 output = 52,476 total
...
**🔍 Analyse LLM:**
- **Pattern temporel**: Irregulier - pas de cycle hebdomadaire strict
- **Saisonnalité**: none
- **Tendance**: hausse vers 200u récente
- **Outliers détectés**: 1u, 300u

**🧠 Raisonnement LLM:**
Le mardi est hors cycle (seule 1 commande à 0u). Les 2 dernières commandes effectives (août 2025) sont à 200u, indiquant une nouvelle tendance. L'historique N-1 montre des volumes plus bas (50-150u) mais moins pertinents. Le pic de 300u de juin 2024 est un outlier ancien. La prochaine commande réelle sera probablement vendredi 17 ou mercredi 16 octobre, avec un volume de 200u basé sur la tendance récente.
...
| [PF1193] GF VIN TOMATE WECK 330ML | 0 | Stock prédit: -75.5u (-40j restants) → prédit 0u mais non commandé |
...
*Rapport généré automatiquement le 2025-12-18T08:41:33.449Z*
