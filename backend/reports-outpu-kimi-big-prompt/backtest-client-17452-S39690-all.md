...
- **Appels**: 22
- **Tokens**: 33,754 input + 101,151 output = 134,905 total
...
| Métrique | Valeur | Interprétation |
|----------|--------|----------------|
| **MAE** | 78.20 unités | Erreur moyenne absolue (symétrique) |
| **wMAPE** | 18.3% | ⚖️ Erreur pondérée robuste (métrique principale) |
...
|---------|--------|------|-----------|----------|------|------------|------------|--------|
| [LV342] LV Organic Broccoli Spread 190 g | 279 | 310 | 31.0 | 10.0% | ✅ partial | ✅ Oui | ✅ Oui | 🤖 LLM |
...
<details>
<summary><strong>1. [LV342] LV Organic Broccoli Spread 190 g</strong> - LLM: 279u vs Médiane: 275u (Réel: 310u)</summary>

**Quantités:**
- 🤖 **LLM prédit**: 279u (confidence: low)
- 📊 **Baseline N-1**: 279u
- 📊 **Médiane**: 275u
- ✅ **Réel commandé**: 310u
- 📉 **Erreur LLM**: 31u (10.0%)
...
**🔍 Analyse LLM:**
- **Pattern temporel**: Aucun pattern stable détecté (seulement 2 commandes sur 3j)
- **Saisonnalité**: none
- **Tendance**: upward_spike
- **Outliers détectés**: Aucun

**🧠 Raisonnement LLM:**
1. RYTHMIQUE : Seulement 2 commandes sur 3j (155u le mar. 26/08, 279u le ven. 29/08). Intervalle atypique. Pas de pattern hebdomadaire stable. 2. JOUR HORS CYCLE : La date demandée (lun. 13/10) n'est pas un jour habituel. Il faut prédire la QUANTITÉ DE LA PROCHAINE COMMANDE (mardi 14/10). 3. ÉVALUATION DES OUTLIERS : La hausse de 155→279 en 3j est suspecte (+80%), mais avec seulement 2 points, impossible de confirmer un outlier vs une tendance de démarrage. 4. MÉTHODE : Dataset critique (<5 points). Guideline : 'privilégie dernière valeur si cohérente avec la tendance'. La tendance est haussière, donc la dernière valeur de 279u est retaine. Cependant, l'écart de 45j depuis la dernière commande pour un produit frais émet un signal d'alerte (rupture possible). Compte tenu du manque de données historiques saisonnières (pas de N-1) et de la volatilité extrême, la prédiction reste à haut risque.
...
**🔍 Analyse LLM:**
- **Pattern temporel**: Aucun cycle régulier identifié (ni hebdomadaire, ni mensuel strict). Les commandes sont éparses et irrégulières sur la période observée.
- **Saisonnalité**: none
- **Tendance**: Baisse nette des volumes observée entre N-1 (100u) et période récente (62u)
- **Outliers détectés**: Aucun

**🧠 Raisonnement LLM:**
Historique limité (4 commandes) avec rupture claire de tendance : 100u en N-1 vs 62u en août 2025. Pas de jour de commande fixe identifiable (commandes sur lundi/mardi/mercredi). Comme le pattern est irrégulier et les volumes ont baissé de 38%, la dernière commande reflète l'état actuel du produit. Les anciens niveaux de 100u apparaissent obsolètes sans signe de reprise.
...
**✅ Quantité LLM**: 279u (confidence: low)
...
|---------|-------------|--------|
| [LV135] LV Tartinade Basilico 190g | 300 | Stock prédit: 241.7u (25j restants) → prédit 300u mais non commandé |
| [LV143] LV Mayonnaise (huile 70%) 200 ml  | 155 | Stock prédit: 126.5u (21j restants) → prédit 155u mais non commandé |
...
| [LV348] LV Tartinade Dattes-Chili 180g BE bio | 195 | Stock prédit: 43.5u (9j restants) → prédit 195u mais non commandé |
| [LV133] LV Tartinade Ananas Coco 190g | 317 | Stock prédit: 165.8u (27j restants) → prédit 317u mais non commandé |
| [LV145] LV Sauce Tartare 200 ml  | 287 | Stock prédit: 13.9u (3j restants) → prédit 287u mais non commandé |
...
| [LV138] LV Tartinade Carotte gingembre  380g | 128 | Stock prédit: 16.4u (6j restants) → prédit 128u mais non commandé |
...
| [LV157] LV Ketchup aux tomates 263 ml bio | 0 | Stock prédit: -111.1u (-71j restants) → prédit 0u mais non commandé |
| [LV156] LV Sauce barbecue 263 ml bio | 0 | Stock prédit: -24.1u (-64j restants) → prédit 0u mais non commandé |
...
*Rapport généré automatiquement le 2025-12-18T08:45:21.111Z*
