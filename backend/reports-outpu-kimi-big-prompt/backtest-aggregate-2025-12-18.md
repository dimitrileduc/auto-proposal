...
- **Date d'exécution** : 18/12/2025 09:51:58
- **Clients analysés** : 48
- **Clients réussis** : 44
- **Clients échoués** : 4
...
|----------|---------|---------|----------------|
| **Recall** | 94.0% | 100.0% | % de besoins réels détectés |
| **Precision** | 40.0% | 39.2% | % de prédictions correctes (60.8% proposés non commandés) |
| **F1-Score** | 52.6% | 55.1% | Équilibre détection/précision |
| **wMAPE** | 29.8% | 24.1% | ⚖️ Écart pondéré robuste (métrique principale) |
| **MAPE** | 33.9% | 30.2% | Écart moyen (info, biaisé) |
| **Bias** | 1.4% | 0.0% | Biais directionnel (>0 = surestime, <0 = sous-estime) |
...
|----------|--------|----------------|
| **Appels LLM** | 793 | Nombre de produits prédits par LLM (>2 commandes historiques) |
| **Tokens Total** | 3 704 732 | 1 185 420 prompt + 2 519 312 completion |
| **Tokens Moyen/Appel** | 4 672 | Tokens moyen par prédiction LLM |
...
*Rapport généré automatiquement le 2025-12-18T08:51:58.241Z*
