...
|----------|---------|---------|----------------|
| **Recall** | 85.6% | 92.0% | % de besoins réels détectés |
| **Precision** | 39.3% | 39.2% | % de prédictions correctes (60.8% proposés non commandés) |
| **F1-Score** | 49.7% | 50.0% | Équilibre détection/précision |
| **wMAPE** | 29.4% | 24.1% | ⚖️ Écart pondéré robuste (métrique principale) |
| **MAPE** | 33.5% | 30.2% | Écart moyen (info, biaisé) |
| **Bias** | 1.2% | 0.0% | Biais directionnel (>0 = surestime, <0 = sous-estime) |
...
*Rapport généré automatiquement le 2025-12-18T08:51:58.262Z*
