...
- **Date d'exécution** : 18/12/2025 11:14:08
- **Clients analysés** : 48
- **Clients réussis** : 48
- **Clients échoués** : 0
...
| **Precision** | 40.4% | 39.2% | % de prédictions correctes (60.8% proposés non commandés) |
| **F1-Score** | 53.3% | 55.1% | Équilibre détection/précision |
| **wMAPE** | 30.9% | 25.0% | ⚖️ Écart pondéré robuste (métrique principale) |
| **MAPE** | 38.2% | 31.9% | Écart moyen (info, biaisé) |
| **Bias** | 5.5% | 0.0% | Biais directionnel (>0 = surestime, <0 = sous-estime) |
...
|----------|--------|----------------|
| **Appels LLM** | 833 | Nombre de produits prédits par LLM (>2 commandes historiques) |
| **Tokens Total** | 2 606 800 | 1 894 972 prompt + 711 828 completion |
| **Tokens Moyen/Appel** | 3 129 | Tokens moyen par prédiction LLM |
...
*Rapport généré automatiquement le 2025-12-18T10:14:08.710Z*
