...
- **Appels**: 16
- **Tokens**: 35,662 input + 12,793 output = 48,455 total
...
**🔍 Analyse LLM:**
- **Pattern temporel**: Commandes irrégulières, plutôt hebdomadaires/bihebdomadaires. Dernières 3 commandes espacées de 6, 6 et 23 jours. Aucun jour fixe détecté (mélange mer./jeu.). Pattern instable.
- **Saisonnalité**: weak
- **Tendance**: Baisse progressive avec forte volatilité. N-1 (sept): 16u → Récent (3 mois): moyenne ~5.75u (-64%). Deux pics (10u, 6u) entourés de creux (1u, 6u).
...
1️⃣ ANALYSE RYTHMIQUE:
   - Intervalles récents: 6 jours (24→18 sept), 6 jours (13→7 août), 23 jours (30 juil→13 août)
   - Aucun jour de semaine stable (alternance mer./jeu.)
   - Pattern hebdomadaire clairement rompu → demande décorrélée du cycle calendaire strict

2️⃣ FILTRAGE OUTLIERS:
   - 16u (sept N-1): Pic isolé, non reproduit récemment → événement exceptionnel ponctuel (peut-être promotion/commande spéciale)
   - 1u (7 août): Creux anormal, probablement rattrapage ou interruption ponctuelle
   - 10u (30 juil) et 6u (24 sept): Dans la fourchette haute mais moins extrêmes

3️⃣ TENDANCE:
   - Nette baisse de N-1 à N: 16u → moyenne 5.75u = -64%
   - Stagnation sur 3 mois récents: 6u-6u-10u-1u = volatilité faible autour de 5-6u
   - Pas de signal de hausse ou baisse nouvelle

4️⃣ SAISONNALITÉ:
   - Une seule donnée N-1 (9/5): Insuffisant pour conclure saisonnalité forte
   - Sept 2024 vs Sept 2025: Évolution -64% (contexte client changé?)
   - Impact saisonnier: WEAK

5️⃣ BASELINE & RECOMMANDATION:
   - Moyenne 3 derniers mois: (6+6+1+10)/4 = 5.75u
   - Médiane: 6u (robuste aux outliers)
   - Dernière commande (24 sept): 6u = tendance la plus récente
   - **PRÉDICTION: 6 unités** (proche de la médiane, cohérent avec pattern stable bas)

JUSTIFICATION MAPE:
- 6u capture la "normalité" de ce client sans sur-investir
- Évite le biais à la hausse du pic de 10u
- Ne reproduit pas l'anomalie de 1u
- Minimise l'erreur vs. volatilité observée
- Confidence MEDIUM car données limitées (N-1 unique + seulement 4 points récents)
...
|---------|-------------|--------|
| [PF0070] FILOU/LD SAUCE ANDALOUSE  10 L | 44 | Stock prédit: 37.6u (29j restants) → prédit 44u mais non commandé |
...
*Rapport généré automatiquement le 2025-12-18T10:10:56.841Z*
