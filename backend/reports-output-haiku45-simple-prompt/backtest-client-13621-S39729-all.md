...
- **Appels**: 118
- **Tokens**: 265,746 input + 100,896 output = 366,642 total
...
|----------|--------|----------------|
| **Précision** | 2.3% | 177 produits prédits, 4 corrects |
...
**🔍 Analyse LLM:**
- **Pattern temporel**: Commandes espacées de ~25-30 jours, sans jour fixe hebdomadaire. Pattern: jeudi 09/10, mardi 16/09, vendredi 22/08
- **Saisonnalité**: none
- **Tendance**: Stable à 200u - aucune donnée N-1 pour comparaison, mais cohérence totale des 3 dernières commandes
...
1. **ANALYSE RYTHMIQUE** 
   - 2025-10-09 (jeudi) → 2025-09-16 (mardi) = 23 jours d'écart
   - 2025-09-16 (mardi) → 2025-08-22 (vendredi) = 25 jours d'écart
   - Pattern identifié: Cycle d'environ 24-25 jours (légèrement irrégulier, non hebdomadaire fixe)
   - La date de prédiction (2025-10-13 lundi) s'inscrit dans ce cycle: 4 jours après la dernière commande du 09/10
   - Pas d'effet rattrapage décelable - le rythme est respecté

2. **FILTRE OUTLIERS & SAISONNALITÉ**
   - Aucune donnée N-1 disponible → pas de comparaison saisonnière possible
   - Les 3 commandes récentes sont IDENTIQUES (200u chacune) → cohérence maximale
   - Aucune fluctuation, aucun pic exceptionnel identifiable
   - Conclusion: demande STABLE, pas d'outliers

3. **TENDANCE & DÉCISION**
   - Tendance: STABLE à 200u
   - Moyenne simple: (200 + 200 + 200) / 3 = 200u
   - Coefficient de variation: 0% → fiabilité maximale
   - Aucune donnée contradictoire pour justifier un écart

4. **JUSTIFICATION DE LA PRÉDICTION**
   - Baseline théorique = 200u (réplication conforme du pattern)
   - En agroalimentaire B2B, la stabilité de commande reflète une consommation régulière maîtrisée
   - Le client a démontré 3 fois de suite une demande de 200u → sa formule de stock/rotation est alignée sur ce volume
   - Recommandation: MAINTENIR 200u sans ajustement

5. **NIVEAU DE CONFIANCE: HIGH**
   - ✓ Cohérence parfaite des 3 dernières données
   - ✓ Cycle temporel régulier (24-25j)
   - ✓ Aucun facteur de perturbation identifié
   - ✗ Seule limite: absence de contexte N-1 (pas de saisonnalité testable)
   → Mais cette limite ne remet pas en question la stabilité observable
...
**🔍 Analyse LLM:**
- **Pattern temporel**: Commande hebdomadaire stable détectée. Historique récent montre 3 commandes en 31 jours (moyenne ~10 jours), mais avec une intensité accrue. N-1 montre des commandes sporadiques sans pattern régulier fixe.
- **Saisonnalité**: weak
- **Tendance**: Hausse nette +24% : passage de 350u (N-1 baseline) à 434u (période récente stable)
...
1. **ANALYSE RYTHMIQUE:**
   - N-1 (2024-2023): Commandes très sporadiques, sans pattern régulier fixe (intervalles: 5j, 13j, 35j, 47j, etc.)
   - Période récente (3 derniers mois 2025): Activation nette avec 3 commandes en 31 jours
   - Intervalles récents: 2025-10-09 vs 2025-09-05 = 34j | 2025-09-05 vs 2025-08-19 = 17j
   - Le client transition vers une demande plus régulière et AUGMENTÉE

2. **FILTRAGE OUTLIERS:**
   - 2024-09-16: 700u = OUTLIER CONFIRMÉ (pic isolé, 2x la baseline moyenne)
   - Janvier-juillet 2024: AUCUNE donnée = zone morte (saison basse probable)
   - Depuis août 2025: STABILISATION À 434u × 3 commandes = nouvelle baseline établie
   - La double entrée du 09-10-2025 (434u + 0u) confirme une seule commande, pas d'erreur de saisie

3. **SAISONNALITÉ:**
   - Octobre N-1: Une commande (272u) ≠ Volume actuel (434u)
   - Pas de pic récurrent détectable à cette date précise
   - Impact saisonnier FAIBLE: La hausse 2025 est plutôt due à une augmentation structurelle de la demande

4. **SYNTHÈSE TENDANCE:**
   - N-1 baseline moyen (hors outlier 700): ~330u
   - Période récente stabilisée: 434u (3/3 commandes identiques)
   - Delta: +104u (+31% vs ancien profil)
   - Lundi 2025-10-13 = jour demandé, pas jour habituel détecté (pas de pattern fixe), mais continuité attendue

5. **DÉCISION:**
   - Le client commande régulièrement depuis août 2025 À 434u
   - Pas d'indication baisse ou hausse supplémentaire
   - Lundi est jour ouvrable, aucune anomalie calendaire
   - **Prédiction = 434u** (reproduire la dernière quantité stable observée)
   - Confiance HAUTE: Données cohérentes, pattern établi sur 3 itérations identiques

Logique agro B2B appliquée: Une augmentation de +31% maintenue sur 3 cycles = changement de volume établi, pas anomalie. Viser la quantité la PLUS PROBABLE minimise le MAPE.
...
**🔍 Analyse LLM:**
- **Pattern temporel**: Commande bi-mensuelle irrégulière, variable selon le jour de la semaine. Pas de cycle fixe strict détecté. Pattern N-1 montre des commandes espacées (entre 7 et 139 jours). Période récente (3 derniers mois) montre un rythme plus serré mais toujours irrégulier (19-26-14 jours d'intervalle).
- **Saisonnalité**: weak
- **Tendance**: Demande stable autour de 400u. Pics ponctuels à 600u-800u identifiés comme événements exceptionnels (2024-06-11 à 800u, 2024-08-08 à 600u, 2025-08-19 à 600u). Baseline consolidée: 400u.
...
**1. ANALYSE RYTHMIQUE:**
- Dernières commandes en période récente (3 mois): 2025-09-10 (mer.), 2025-09-05 (ven.), 2025-08-19 (mar.)
- Intervalles: 5 jours (05 vs 10 sept.), puis 17 jours avant (19 août)
- Le client n'a PAS de cycle fixe strict (lun/ven récurrent)
- Rythme actuel: commandes espacées de 5-20 jours approximativement

**2. FILTRAGE DES OUTLIERS:**
- Pics détectés: 800u (juin 2024 - one-shot probable), 600u (août 2024 + août 2025 - possible saisonnalité légère d'été)
- Dernière commande 600u en 2025-08-19 (mardi) → pattern d'été?
- Mais trois commandes les plus récentes (05, 10 sept., pattern stable) reviennent toutes à **400u**
- La saisonnalité d'été a disparu → tendance stable confirmée

**3. SYNTHÈSE & DÉCISION:**
- **Baseline théorique**: 400u (mode dominant sur 12 enregistrements; 7 occurrences exactes à 400u)
- **Tendance récente**: Stable à 400u (3 derniers mois)
- **Jour de la semaine (lundi 13-10)**: Historique montre 2 lundis à 400u précédents
- **Saisonnalité**: WEAK (légère hausse été disparue, octobre = retour à demande standard)
- **Rupture de rythme**: Aucune détectée pour cette date spécifique

**4. RATTRAPAGE POTENTIEL:**
- Dernière commande: 2025-09-10 (il y a 33 jours)
- Intervalle n-1: jusqu'à 139 jours observés, mais période récente = 5-20 jours
- Pas de signal de rattrapage massif; client semble suivre son rythme irrégulier normal

**CONCLUSION:** Recommandation = **400 unités** (confiance HAUTE)
- Aligne avec baseline stable
- Cohérent avec dernières 3 commandes
- Conforme au jour de la semaine (lundi historiquement 400u)
- Contexte saisonnier d'octobre = demande standard, pas de pic prévu
...
| [REB01] ReBEL chips premium & bio - sel de mer 125g | 60 | Stock prédit: 79.7u (9j restants) → prédit 60u mais non commandé |
...
| [TEN02] TENSAÏ TEA  thé noir bio au gingembre 330ml | 75 | Stock prédit: 47.8u (23j restants) → prédit 75u mais non commandé |
| [OCC03] OCCHIOLINO SUCO - citron, miel & gingembre - 500ml  | 8 | Stock prédit: 8.1u (25j restants) → prédit 8u mais non commandé |
| [OCC01] OCCHIOLINO huile d'olive extra vierge 500ml | 6 | Stock prédit: 3.6u (16j restants) → prédit 6u mais non commandé |
...
| [PF0088] FILOU VOL AU VENT 800 GR | 12 | Stock prédit: 18.0u (12j restants) → prédit 12u mais non commandé |
...
| [NUT03] NUTS & BERRIES energy bar Mediterran bio 40g | 28 | Stock prédit: 16.0u (22j restants) → prédit 28u mais non commandé |
...
| [RIT04] RITCHIE Pamplemousse - verre 275ml | 15 | Stock prédit: 13.1u (24j restants) → prédit 15u mais non commandé |
| [RIT05] RITCHIE Cola - verre 275ml | 25 | Stock prédit: 18.9u (22j restants) → prédit 25u mais non commandé |
...
| [RIT08] RITCHIE Citron - canette 330ml | 7 | Stock prédit: 1.1u (3j restants) → prédit 7u mais non commandé |
| [RIT02] RITCHIE Citron - verre 275ml | 25 | Stock prédit: 16.7u (16j restants) → prédit 25u mais non commandé |
...
| [RISH03] RISH kombucha BIO - gingembre 330ml | 26 | Stock prédit: 8.3u (12j restants) → prédit 26u mais non commandé |
...
| [PF1224] FILOU BOULETTES TOMATE 800 GR | 4 | Stock prédit: -7.3u (-15j restants) → prédit 4u mais non commandé |
...
| [RIT01] RITCHIE Orange - verre 275ml | 14 | Stock prédit: 6.2u (11j restants) → prédit 14u mais non commandé |
...
| [PF1527] JF SAUCE BEARNAISE 250ML WECK | 250 | Stock prédit: -61.1u (-7j restants) → prédit 250u mais non commandé |
...
| [PF0084] FILOU CARBONNADES 800 GR | 7 | Stock prédit: -1.5u (-5j restants) → prédit 7u mais non commandé |
| [PAO03] PAOLA cola canette 330ml - le cola des Belges | 35 | Stock prédit: -2.4u (-2j restants) → prédit 35u mais non commandé |
| [PAO04] PAOLA cola ZERO canette 330ml - le cola des Belges  | 35 | Stock prédit: 11.1u (14j restants) → prédit 35u mais non commandé |
| [PF3237] LV MAYONNAISE POIVRE 250ML WECK  | 300 | Stock prédit: -211.1u (-19j restants) → prédit 300u mais non commandé |
| [PF1775] TARTINAPERO BIO PAPRIKA 200ML | 428 | Stock prédit: 24.3u (2j restants) → prédit 428u mais non commandé |
...
| [PF1469] JF MAYONNAI TRUFFES 250ML WECK | 200 | Stock prédit: 141.9u (20j restants) → prédit 200u mais non commandé |
...
| [PF1557] LV TARTINADE BIO AUBERGINE 200 | 2200 | Stock prédit: 929.4u (30j restants) → prédit 2200u mais non commandé |
...
| [PI3072] PI TARTI POIS CHICHES BIO CONS 250G  | 4260 | Stock prédit: 1449.8u (18j restants) → prédit 4260u mais non commandé |
| [PI3073] PI TARTI TOMATE BIO CONS 250 | 7500 | Stock prédit: 2645.5u (19j restants) → prédit 7500u mais non commandé |
| [PI3346] PI TARTINADE BETTERAVE BIO CONS 250G | 5700 | Stock prédit: 714.5u (6j restants) → prédit 5700u mais non commandé |
| [PF1721] LV VIN CAESAR PET 250 BIO | 260 | Stock prédit: 64.5u (16j restants) → prédit 260u mais non commandé |
| [PF1629] LV TARTINADE BIO TOMATE 200ML | 1900 | Stock prédit: 781.2u (23j restants) → prédit 1900u mais non commandé |
...
| [PI3200] PI TARTI AUBERGINE BIO CONS 250 | 1356 | Stock prédit: -302.6u (-12j restants) → prédit 1356u mais non commandé |
...
| [PF1484] JF VINAIGRETTE FH WECK 200ML | 145 | Stock prédit: -127.9u (-43j restants) → prédit 145u mais non commandé |
| [PF3226] JF SAUCE LAPIN 380GX6 | 800 | Stock prédit: -59.0u (-26j restants) → prédit 800u mais non commandé |
| [PF1534] JF SAUCE COCKTAIL 250ML WECK | 150 | Stock prédit: -57.3u (-21j restants) → prédit 150u mais non commandé |
...
| [REB06] ReBEL chips premium & bio - paprika fumé 35g | 50 | Stock prédit: -56.5u (-45j restants) → prédit 50u mais non commandé |
...
| [PI3203] PI TARTI MANGUE BIO CONS 250 | 780 | Stock prédit: 230.6u (18j restants) → prédit 780u mais non commandé |
| [PF1461] LV TARTARE BIO 200ML | 200 | Stock prédit: -71.5u (-18j restants) → prédit 200u mais non commandé |
| [PF1640] JF MITRAILLETTE SQUEEZE 300ML | 140 | Stock prédit: -267.2u (-76j restants) → prédit 140u mais non commandé |
...
*Rapport généré automatiquement le 2025-12-18T10:12:46.917Z*
