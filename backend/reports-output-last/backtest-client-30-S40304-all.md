...
- **Appels**: 8
- **Tokens**: 12,778 input + 33,299 output = 46,077 total
...
**🔍 Analyse LLM:**
- **Pattern temporel**: Commandes le jeudi (4 fois) puis le lundi (3 fois). Fréquence historique ~10-12 jours, Récente ~40 jours (forte rupture). Toutes les commandes 2025 sont de 1u, montrant une stabilisation au minimum.
- **Saisonnalité**: none
- **Tendance**: sharply_downward
- **Outliers détectés**: -5u, 4u

**🧠 Raisonnement LLM:**
Le mercredi est hors cycle (seulement 1 commande sur 15 points). La règle spéciale s'applique: NE PAS prédire 0 mais la quantité de la PROCHAINE commande probable. Les 3 dernières commandes (2025-08-26, 2025-10-02, 2025-10-02) sont TOUTES de 1u, montrant une stabilisation claire au volume minimum. Les pics historiques (3u, 4u, 5u) sont obsolètes et correspondent à une période où le produit avait plus d'activité. La rupture de tendance est nette: fréquence divisée par 3-4 et volume divisé par 2. Le client ne commande plus ce produit qu'en quantité unitaire d'appoint. Prédire la prochaine commande = prédire 1u.
...
**🔍 Analyse LLM:**
- **Pattern temporel**: Aucune périodicité fiable détectée. Les seuls intervalles cohérents sont 37-38 jours entre les commandes récentes (août-octobre 2025), mais la saisonnalité est inexistante.
- **Saisonnalité**: none
- **Tendance**: stable
- **Outliers détectés**: Aucun

**🧠 Raisonnement LLM:**
Absence totale de variabilité quantitative (toujours 1u). Le jour de prédiction est hors cycle, mais la règle interdit le 0. La prochaine commande, quelle que soit sa date, sera de 1u.
...
| [JF023] JF MOUTARDE DOUCE 250ML WECK | 0 | Stock prédit: 0.2u (10j restants) → prédit 0u mais non commandé |
...
*Rapport généré automatiquement le 2025-12-18T08:09:29.828Z*
