...
- **Appels**: 13
- **Tokens**: 20,551 input + 34,232 output = 54,783 total
...
**🔍 Analyse LLM:**
- **Pattern temporel**: Tuesdays every 20-35 days
- **Saisonnalité**: none
- **Tendance**: stable
- **Outliers détectés**: Aucun

**🧠 Raisonnement LLM:**
Rythme mardi irrégulier (~21-35j) mais quantité ultra-stable à 112u observée 4 fois. Le 0 du 16/10 (jeudi) est hors cycle et non reproductible pour un mardi. Prédiction alignée sur le jour habituel avec valeur récurrente.
...
*Rapport généré automatiquement le 2025-12-18T08:07:12.596Z*
