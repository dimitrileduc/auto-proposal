...
|----------|---------|---------|----------------|
| **Recall** | 82.8% | 100.0% | % de besoins réels détectés |
| **Precision** | 36.7% | 35.1% | % de prédictions correctes (64.9% proposés non commandés) |
| **F1-Score** | 45.7% | 50.0% | Équilibre détection/précision |
| **wMAPE** | 43.0% | 33.3% | ⚖️ Écart pondéré robuste (métrique principale) |
| **MAPE** | 45.0% | 42.8% | Écart moyen (info, biaisé) |
| **Bias** | -5.4% | 0.0% | Biais directionnel (>0 = surestime, <0 = sous-estime) |
...
*Rapport généré automatiquement le 2025-12-18T08:16:48.451Z*
