...
- **Appels**: 13
- **Tokens**: 20,443 input + 52,204 output = 72,647 total
...
|---------|--------|------|-----------|----------|------|------------|------------|--------|
| [PF1194] GF VIN FINES HERBES WECK 330ML | 0 | 160 | 160.0 | 100.0% | ✅ partial | ✅ Oui | ✅ Oui | 🤖 LLM |
...
<details>
<summary><strong>1. [PF1194] GF VIN FINES HERBES WECK 330ML</strong> - LLM: 0u vs Médiane: 145u (Réel: 160u)</summary>
...
- 📊 **Médiane**: 145u
- ✅ **Réel commandé**: 160u
- 📉 **Erreur LLM**: 160u (100.0%)
- 📉 **Erreur Médiane**: 15u (9.4%)

**🔍 Analyse LLM:**
- **Pattern temporel**: non_weekly
- **Saisonnalité**: none
- **Tendance**: unknown
- **Outliers détectés**: Aucun

**🧠 Raisonnement LLM:**
Après analyse approfondie de l'historique, je constate que le produit PF1194 n'a **aucune commande enregistrée sur les 3 derniers mois** (hormis une unique commande en août 2025). L'écart entre le dernier point de données (25/08/2025) et la date de prédiction (11/11/2025) est de **77 jours**, soit plus de 2 mois et demi d'absence totale de commande. En B2B agroalimentaire, un tel silence commercial sur 3 mois indique fortement **un arrêt du produit par le client** (fin de gamme, substitution, ou désengagement). Les rares commandes précédentes étaient éparses et sans pattern rythmique exploitable. **Prédire une valeur non nulle serait non fondée statistiquement et augmenterait artificiellement le MAPE.** Le critère d'activation du '0 autorisé pour produit arrêté' est rempli.
...
*Rapport généré automatiquement le 2025-12-18T08:13:41.575Z*
