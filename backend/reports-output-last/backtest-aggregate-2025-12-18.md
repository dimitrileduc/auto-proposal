...
- **Date d'exécution** : 18/12/2025 09:16:48
- **Clients analysés** : 49
- **Clients réussis** : 42
- **Clients échoués** : 7
...
|----------|---------|---------|----------------|
| **Recall** | 97.5% | 100.0% | % de besoins réels détectés |
| **Precision** | 37.8% | 37.0% | % de prédictions correctes (63.0% proposés non commandés) |
| **F1-Score** | 49.3% | 54.0% | Équilibre détection/précision |
| **wMAPE** | 43.9% | 34.5% | ⚖️ Écart pondéré robuste (métrique principale) |
| **MAPE** | 45.1% | 42.2% | Écart moyen (info, biaisé) |
| **Bias** | -5.6% | -0.6% | Biais directionnel (>0 = surestime, <0 = sous-estime) |
...
|----------|--------|----------------|
| **Appels LLM** | 737 | Nombre de produits prédits par LLM (>2 commandes historiques) |
| **Tokens Total** | 3 416 025 | 1 101 791 prompt + 2 314 234 completion |
| **Tokens Moyen/Appel** | 4 635 | Tokens moyen par prédiction LLM |
...
**Comment se répartissent les 42 clients ?**
...
*Rapport généré automatiquement le 2025-12-18T08:16:48.447Z*
