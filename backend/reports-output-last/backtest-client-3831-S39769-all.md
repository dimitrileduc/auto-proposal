...
- **Appels**: 9
- **Tokens**: 13,620 input + 35,639 output = 49,259 total
...
**🔍 Analyse LLM:**
- **Pattern temporel**: Intervalles irréguliers historiquement (1 semaine à 6 mois), mais accélération récente (10-19 jours entre commandes). Mercredi est un jour de commande récurrent (5/14 commandes).
- **Saisonnalité**: none
- **Tendance**: rupture nette à la hausse
- **Outliers détectés**: Aucun

**🧠 Raisonnement LLM:**
ANALYSE RYTHMIQUE : Le mercredi est un jour de commande historique fréquent (5 commandes). Le pattern historique était irrégulier mais les 3 derniers mois montrent une accélération claire avec intervalles de 10-19 jours. L'écart de 13 jours entre le 02/10/2025 et la date cible est cohérent. FILTRAGE OUTLIERS : Les 250u ne sont pas des outliers ponctuels mais une NOUVELLE TENDANCE (3 occurrences consécutives). La valeur historique moyenne (~75u) est obsolète. Le pic de 55u le 2025-07-16 marque la transition. SYNTHESE : Rupture de tendance nette avec consolidation. La répétition de 250u et le respect du jour habituel (mercredi) imposent de privilégier la donnée la plus récente et la plus probable.
...
| [PF3274] JF BURGER SAUCE 925ML | 3 | Stock prédit: -0.5u (-22j restants) → prédit 3u mais non commandé |
...
*Rapport généré automatiquement le 2025-12-18T08:15:55.849Z*
