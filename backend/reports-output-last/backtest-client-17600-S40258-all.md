...
- **Appels**: 19
- **Tokens**: 28,898 input + 60,091 output = 88,989 total
...
**🔍 Analyse LLM:**
- **Pattern temporel**: Joker
- **Saisonnalité**: none
- **Tendance**: none
- **Outliers détectés**: Aucun

**🧠 Raisonnement LLM:**
**ANALYSE RYTHMIQUE**: Les commandes sont irrégulières (intervalles de 6 à 126 jours) sans cycle hebdomadaire ou mensuel fixe. Le mardi est représenté dans l'historique (2025-10-14 et 2023-12-19), donc ce n'est PAS un jour hors cycle. **OUTLIERS**: La commande de 200u (août 2024) est un creux isolé entre des valeurs de 350u, probablement liée à un événement exceptionnel. Les valeurs récentes de 434u (oct./nov. 2025) ne sont pas des outliers majeurs (+23% vs moyenne) mais indiquent une nouvelle tendance. **TENDANCE**: Baseline historique N-1 = 350u. Données récentes montrent une élévation claire avec une valeur de 434u répétée 2 fois sur 3 commandes, contre 1 commande à 350u (oct. 2025). **DÉCISION**: Avec des données limitées et irrégulières, on privilégie la tendance récente la plus forte. La dernière commande est de 434u, cohérente avec la commande précédente du même niveau. Le 434u représente le nouveau standard établi en 2025.
...
**🔍 Analyse LLM:**
- **Pattern temporel**: Cycle hebdomadaire flexible avec stabilité de volume
- **Saisonnalité**: none
- **Tendance**: stable
- **Outliers détectés**: Aucun

**🧠 Raisonnement LLM:**
Parfaite stabilité des 3 dernières commandes (434u chacune). Le mardi est jour de commande valide (14/10). Outlier ancien 864u exclu. Demande B2B routinière = quantité inchangée.
...
**🔍 Analyse LLM:**
- **Pattern temporel**: Mensuelle irrégulière (intervalles 6-58j, moy ~25j)
- **Saisonnalité**: none
- **Tendance**: stable
- **Outliers détectés**: -1u, 2u, -3u, 2u, -1u

**🧠 Raisonnement LLM:**
PRODUIT RELANCÉ - RUPTURE DE TENDANCE NETTE. Les 4 dernières commandes (août à octobre 2025) sont toutes de 200u, montrant une parfaite stabilité post-relancement (après un gap de 294j). Les outliers 600u (sept 2024) et 400u (déc 2023) sont historiques et non répétitifs. Le jour prédit (mardi) est historiquement valide (5 commandes sur 14). La tendance la plus récente et fiable prime sur l'historique ancien.
...
*Rapport généré automatiquement le 2025-12-18T08:11:20.268Z*
