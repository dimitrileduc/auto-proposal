...
| **Precision** | 41.6% | 50.0% | % de prédictions correctes (50.0% proposés non commandés) |
| **F1-Score** | 55.8% | 66.7% | Équilibre détection/précision |
| **wMAPE** | 47.6% | 42.7% | ⚖️ Écart pondéré robuste (métrique principale) |
| **MAPE** | 58.3% | 58.3% | Écart moyen (info, biaisé) |
| **Bias** | 29.5% | 0.0% | Biais directionnel (>0 = surestime, <0 = sous-estime) |
...
**Comment se répartissent les 3 clients ?**
...
*Rapport généré automatiquement le 2025-12-18T08:16:48.449Z*
