...
- **Appels**: 6
- **Tokens**: 5,268 input + 2,087 output = 7,355 total
...
|---------|--------|------|-----------|----------|------|------------|------------|--------|
| [MATE01] MATE MATE thé glacé bio pétillant au yerba maté verre 330ml | 54 | 54 | 0.0 | 0.0% | 🎯 exact | ✅ Oui | ✅ Oui | 🤖 LLM |
...
<details>
<summary><strong>1. [MATE01] MATE MATE thé glacé bio pétillant au yerba maté verre 330ml</strong> - LLM: 54u vs Médiane: 120u (Réel: 54u)</summary>

**Quantités:**
- 🤖 **LLM prédit**: 54u (confidence: medium)
- 📊 **Baseline N-1**: 57u
- 📊 **Médiane**: 120u
- ✅ **Réel commandé**: 54u
- 📉 **Erreur LLM**: 0u (0.0%)
...
**🔍 Analyse LLM:**
- **Pattern temporel**: Cycle de 2 à 3 semaines, principalement le mardi
- **Saisonnalité**: none
- **Tendance**: Baisse progressive identifiée sur les deux derniers cycles
- **Outliers détectés**: 126u, 120u

**🧠 Raisonnement LLM:**
Étape 1: Identification de deux pics (120u et 126u) comme outliers potentiels (stockage initial ou promo de rentrée), la demande de fond se stabilisant autour de 54-60u. Étape 2: Aucune donnée N-1 disponible pour confirmer la saisonnalité, impact considéré comme neutre. Étape 3: On observe un ralentissement du volume (126 -> 54) et un espacement des commandes (13 jours puis 12 jours). La demande actuelle intervient un dimanche, légèrement en avance sur le cycle habituel du mardi. Étape 4: Application d'une stratégie conservatrice basée sur la dernière commande (54u) pour éviter le surstockage face à une tendance baissière récente, tout en assurant une couverture de 2 semaines.
...
**✅ Quantité LLM**: 54u (confidence: medium)
**📊 Quantité Réelle**: 54u
...
| [ORG01] ORGANICA crunchy fruit ananas 16g | 1 | Stock prédit: -11.7u (-65j restants) → prédit 1u mais non commandé |
| [ORG10] ORGANICA crunchy fruit mangue 18g | 1 | Stock prédit: -19.6u (-59j restants) → prédit 1u mais non commandé |
...
*Rapport généré automatiquement le 2025-12-18T12:09:23.025Z*
