...
| **F1-Score** | 41.2% | Score équilibré global |
...
|---------|---------------|--------|
| [KOKO02] KOKO Kombucha Lemon Ginger 330ml | 2 | Jamais commandé avant dans les 120j précédents (pas d'historique) |
| [MF0029] MF Tarti Datte chili 250g | 1 | Jamais commandé avant dans les 120j précédents (pas d'historique) |
| [MF0031] MF Tarti Olives verte 250g  | 1 | Jamais commandé avant dans les 120j précédents (pas d'historique) |
...
| [VID0009] Consigne casier | 7 | Jamais commandé avant dans les 120j précédents (pas d'historique) |
| [VID0010] Consigne casier | 42 | Jamais commandé avant dans les 120j précédents (pas d'historique) |


---

*Rapport généré automatiquement le 2025-12-18T12:14:07.127Z*
