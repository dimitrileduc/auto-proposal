...
- **Appels**: 42
- **Tokens**: 42,802 input + 15,292 output = 58,094 total
...
|----------|--------|----------------|
| **Précision** | 7.1% | 56 produits prédits, 4 corrects |
...
**🔍 Analyse LLM:**
- **Pattern temporel**: Faible fréquence, environ une commande tous les 20 à 30 jours, sans jour fixe strict.
- **Saisonnalité**: weak
- **Tendance**: Baisse progressive identifiée (Moyenne 3-4u en 2024 vs 1-2u fin 2025)
- **Outliers détectés**: 6u

**🧠 Raisonnement LLM:**
ÉTAPE 1 (De-eventing) : La commande de 6u d'avril 2024 est traitée comme un outlier car elle double les volumes habituels. La baseline se situe entre 1 et 2u. ÉTAPE 2 (Saisonnalité) : Pas de pic majeur sur la période de novembre en N-1, le produit est stable en fin d'année. ÉTAPE 3 (Tendance) : On observe un ralentissement notable sur les 3 derniers mois avec des commandes de 1 et 2u contre 3u l'année précédente à la même époque. ÉTAPE 4 (Recommandation) : Compte tenu de la baisse de régime et de la faible fréquence, une commande de 2u est recommandée pour couvrir le besoin mensuel sans risque de surstockage, en restant conservateur face à la tendance de 2025.
...
**🔍 Analyse LLM:**
- **Pattern temporel**: Cycle irrégulier, environ mensuel (30-45 jours)
- **Saisonnalité**: weak
- **Tendance**: Hausse récente du volume moyen (+150%)
- **Outliers détectés**: 10u

**🧠 Raisonnement LLM:**
Étape 1: Nettoyage de l'historique en excluant les pics de 10 unités (avril 2024 et sept 2025) considérés comme des stocks de sécurité ou promotions, ramenant la moyenne de fond à 2.8u. Étape 2: Faible impact saisonnier visible, bien que la période de fin d'année montre historiquement une activité stable. Étape 3: Tendance à la hausse sur les volumes récents malgré la faible fréquence. Étape 4: La dernière commande remontant à fin septembre (soit > 45 jours), un besoin de réapprovisionnement de fond est certain. Nous recommandons 4 unités pour couvrir la demande de fin d'année sans risque de surstockage majeur sur un produit à rotation lente.
...
| [JF001] JF MAYONNAI TRUFFES 250ML WECK | 4 | Stock prédit: -2.2u (-7j restants) → prédit 4u mais non commandé |
...
| [JF054] JF LEMON MAYONNAISE 250ml Weck | 1 | Stock prédit: -0.8u (-18j restants) → prédit 1u mais non commandé |
...
| [TVF003] TVF TARTINADE BIO CAROTTE 180g | 2 | Stock prédit: -0.9u (-22j restants) → prédit 2u mais non commandé |
...
*Rapport généré automatiquement le 2025-12-18T12:09:25.913Z*
