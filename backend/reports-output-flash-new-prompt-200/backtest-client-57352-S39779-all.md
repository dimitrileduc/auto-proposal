...
- **Appels**: 12
- **Tokens**: 10,761 input + 3,875 output = 14,636 total
...
| **MAPE** | 60.7% | Erreur moyenne en % (biaisé, pour info) |
...
| [LV134] LV BIO Tartinade Olives Vertes 190g | 6 | 2 | 4.0 | 200.0% | ✅ partial | ✅ Oui | ✅ Oui | 🤖 LLM |
...
**🔍 Analyse LLM:**
- **Pattern temporel**: Commande sporadique (mensuelle ou bimensuelle le jeudi)
- **Saisonnalité**: none
- **Tendance**: Stable à 2u
- **Outliers détectés**: Aucun

**🧠 Raisonnement LLM:**
L'analyse des données montre une stabilité remarquable sur ce produit avec une quantité fixe de 2 unités par commande. Etape 1 : Aucun outlier n'est détecté, le volume est constant. Etape 2 : Pas de saisonnalité marquée entre juillet-septembre N-1 et la période actuelle. Etape 3 : La tendance est plate (stable à 2u) et le jour de commande (jeudi) est respecté. Etape 4 : En l'absence de signal de croissance ou de promotion, la recommandation reste conservatrice à 2 unités pour couvrir le besoin habituel sans créer de surstock.
...
**🧠 Raisonnement LLM:**
L'analyse est basée sur un historique très limité (2 points de données). Etape 1: Aucune valeur aberrante détectée, la demande de fond est de 1 unité. Etape 2: Aucune donnée N-1 disponible pour confirmer une saisonnalité, bien que le secteur agroalimentaire suggère une baisse potentielle hors période estivale pour des limonades. Etape 3: La fréquence semble être mensuelle (intervalle exact de 31 jours entre août et septembre), la commande actuelle intervient 35 jours après la dernière, correspondant au cycle observé. Etape 4: La tendance est stable à 1 unité par commande. En l'absence de signaux de croissance ou de stockage de sécurité nécessaire, la recommandation reste conservatrice à 1 unité.

</details>


<details>
<summary><strong>3. [LV134] LV BIO Tartinade Olives Vertes 190g</strong> - LLM: 6u vs Médiane: 2u (Réel: 2u)</summary>
...
**🧠 Raisonnement LLM:**
ÉTAPE 1 (Outliers) : Impossible à déterminer sans historique. ÉTAPE 2 (Saisonnalité) : Produit apéritif bio (Olives) généralement stable mais sans données N-1 pour confirmer. ÉTAPE 3 (Tendance) : Absence totale de commandes sur les 3 derniers mois, suggérant un nouveau référencement ou une réactivation de fiche. ÉTAPE 4 (Recommandation) : En l'absence de données, une approche conservatrice est adoptée en proposant un colisage standard minimal (estimé à 6 unités pour ce type de pot 190g) pour tester la demande sans risquer de surstockage sur un produit n'ayant pas tourné récemment.
...
| [LV135] LV Tartinade Basilico 190g | 2 | Stock prédit: 0.2u (10j restants) → prédit 2u mais non commandé |
...
*Rapport généré automatiquement le 2025-12-18T12:11:39.235Z*
