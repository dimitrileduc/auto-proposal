...
- **Appels**: 13
- **Tokens**: 11,959 input + 4,476 output = 16,435 total
...
| **wMAPE** | 97.1% | ⚖️ Erreur pondérée robuste (métrique principale) |
| **MAPE** | 119.3% | Erreur moyenne en % (biaisé, pour info) |
...
**🔍 Analyse LLM:**
- **Pattern temporel**: Ponctuel / Long cycle (> 30j)
- **Saisonnalité**: none
- **Tendance**: Stable à 2u
- **Outliers détectés**: Aucun

**🧠 Raisonnement LLM:**
Étape 1: Aucune donnée aberrante identifiée, l'unique commande de 2 unités sert de base. Étape 2: Absence de données N-1 pour confirmer une saisonnalité, produit traité comme stable. Étape 3: Un intervalle de plus de 30 jours suggère un besoin de réapprovisionnement de fond plutôt qu'une accélération de flux. Étape 4: En l'absence d'historique dense, la recommandation reste conservatrice en s'alignant sur le dernier volume connu (2u) pour couvrir la demande sans risquer le sur-stockage sur un produit de niche (mayonnaise truffée).
...
- **Saisonnalité**: weak
- **Tendance**: Hausse progressive (de 4-6u à 8-10u)
- **Outliers détectés**: 2u

**🧠 Raisonnement LLM:**
ÉTAPES 1 & 2 : Nettoyage de la commande de 2u (06/08) considérée comme un ajustement mineur. La demande de fond historique se situe autour de 6u. La saisonnalité N-1 montre une activité en octobre (8u) supérieure à septembre (4u), suggérant un pic de consommation automnal. ÉTAPE 3 : On observe une tendance haussière sur les deux derniers mois (8u puis 10u), indiquant une accélération de la rotation du produit TVF002. ÉTAPE 4 : En lissant la tendance récente (9u de moyenne sur les 2 derniers mois) et en intégrant le léger boost saisonnier d'octobre observé en N-1, une commande de 9 unités est recommandée pour couvrir le mois à venir sans risque de surstockage majeur, tout en restant conservateur face au pic de 10u de septembre.
...
**🔍 Analyse LLM:**
- **Pattern temporel**: Irrégulier avec cycle approximatif de 15 à 30 jours
- **Saisonnalité**: weak
- **Tendance**: Baisse progressive -80% sur le volume récent
- **Outliers détectés**: Aucun

**🧠 Raisonnement LLM:**
Étape 1: Aucune valeur n'est identifiée comme outlier, les volumes oscillant naturellement entre 2u et 6u en N-1. Étape 2: La saisonnalité semble faible, bien qu'un ralentissement soit visible en fin d'année 2024 (passage de 5u à 2u en octobre). Étape 3: La tendance récente est très inquiétante avec une seule commande de 1u en août 2025, suggérant soit une perte de vitesse du produit, soit un stock résiduel important. Étape 4: En croisant la moyenne historique (4.6u) et la faiblesse de la demande récente (1u), je recommande une quantité conservatrice de 2u pour couvrir le besoin immédiat sans risquer le sur-stockage sur une référence dont la rotation ralentit fortement par rapport à N-1 au mois d'octobre (2u le 2024-10-22). La confiance est faible car les données de 2025 sont quasi-inexistantes (une seule commande).
...
| [TVF006] TVF TARTINADE BIO TOMATE 180g | 8 | Stock prédit: 3.0u (11j restants) → prédit 8u mais non commandé |
...
| [DAF001] DAF Elderflower with Pomegrenade juice 25cl | 3 | Stock prédit: 2.9u (19j restants) → prédit 3u mais non commandé |
| [DAF002] DAF Lime and Ginger with Jasmine flower 25cl | 4 | Stock prédit: 1.8u (14j restants) → prédit 4u mais non commandé |
| [DAF003] DAF Passionfruit with Hibiscus flower 25cl | 4 | Stock prédit: 2.5u (15j restants) → prédit 4u mais non commandé |
...
*Rapport généré automatiquement le 2025-12-18T12:11:27.129Z*
