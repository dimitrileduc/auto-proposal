...
- **Date d'exécution** : 18/12/2025 13:16:42
- **Clients analysés** : 191
- **Clients réussis** : 191
- **Clients échoués** : 0
...
|----------|---------|---------|----------------|
| **Recall** | 91.8% | 100.0% | % de besoins réels détectés |
| **Precision** | 50.2% | 50.0% | % de prédictions correctes (50.0% proposés non commandés) |
| **F1-Score** | 59.9% | 66.7% | Équilibre détection/précision |
| **wMAPE** | 47.1% | 39.8% | ⚖️ Écart pondéré robuste (métrique principale) |
| **MAPE** | 50.5% | 41.7% | Écart moyen (info, biaisé) |
| **Bias** | -0.3% | -1.4% | Biais directionnel (>0 = surestime, <0 = sous-estime) |
...
|----------|--------|----------------|
| **Appels LLM** | 2451 | Nombre de produits prédits par LLM (>2 commandes historiques) |
| **Tokens Total** | 3 202 837 | 2 350 499 prompt + 852 338 completion |
| **Tokens Moyen/Appel** | 1 307 | Tokens moyen par prédiction LLM |
...
**Comment se répartissent les 191 clients ?**
...
*Rapport généré automatiquement le 2025-12-18T12:16:42.431Z*
