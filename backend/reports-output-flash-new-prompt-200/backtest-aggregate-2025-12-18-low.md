...
|----------|---------|---------|----------------|
| **Recall** | 96.0% | 100.0% | % de besoins réels détectés |
| **Precision** | 52.6% | 50.0% | % de prédictions correctes (50.0% proposés non commandés) |
| **F1-Score** | 63.4% | 66.7% | Équilibre détection/précision |
| **wMAPE** | 30.8% | 0.0% | ⚖️ Écart pondéré robuste (métrique principale) |
| **MAPE** | 31.7% | 0.0% | Écart moyen (info, biaisé) |
| **Bias** | 11.9% | 0.0% | Biais directionnel (>0 = surestime, <0 = sous-estime) |
...
**Comment se répartissent les 25 clients ?**
...
*Rapport généré automatiquement le 2025-12-18T12:16:42.433Z*
