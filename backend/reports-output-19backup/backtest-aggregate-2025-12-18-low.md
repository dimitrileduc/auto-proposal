...
|----------|---------|---------|----------------|
| **Recall** | 0.0% | 0.0% | % de besoins réels détectés |
| **Precision** | 0.0% | 0.0% | % de prédictions correctes (100.0% proposés non commandés) |
| **F1-Score** | 0.0% | 0.0% | Équilibre détection/précision |
| **wMAPE** | 0.0% | 0.0% | ⚖️ Écart pondéré robuste (métrique principale) |
| **MAPE** | 0.0% | 0.0% | Écart moyen (info, biaisé) |
| **Bias** | 0.0% | 0.0% | Biais directionnel (>0 = surestime, <0 = sous-estime) |
...
*Rapport généré automatiquement le 2025-12-18T21:36:16.161Z*
