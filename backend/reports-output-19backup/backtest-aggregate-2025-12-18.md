...
- **Date d'exécution** : 18/12/2025 22:36:16
- **Clients analysés** : 46
- **Clients réussis** : 46
- **Clients échoués** : 0
...
|----------|---------|---------|----------------|
| **Recall** | 72.1% | 82.6% | % de besoins réels détectés |
| **Precision** | 47.5% | 50.0% | % de prédictions correctes (50.0% proposés non commandés) |
| **F1-Score** | 50.9% | 60.2% | Équilibre détection/précision |
| **wMAPE** | 38.1% | 26.8% | ⚖️ Écart pondéré robuste (métrique principale) |
| **MAPE** | 41.0% | 28.7% | Écart moyen (info, biaisé) |
...
|----------|--------|----------------|
| **Appels LLM** | 1246 | Nombre de produits prédits par LLM (>2 commandes historiques) |
| **Tokens Total** | 1 360 922 | 723 343 prompt + 637 579 completion |
| **Tokens Moyen/Appel** | 1 092 | Tokens moyen par prédiction LLM |
...
**Comment se répartissent les 46 clients ?**
...
*Rapport généré automatiquement le 2025-12-18T21:36:16.157Z*
