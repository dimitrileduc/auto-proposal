...
- **Appels**: 18
- **Tokens**: 8,782 input + 9,137 output = 17,919 total
...
**Quantités:**
- 🤖 **LLM prédit**: 60u (confidence: high)
- 📊 **Baseline N-1**: 60u
- 📊 **Médiane**: 120u
- ✅ **Réel commandé**: 54u
- 📉 **Erreur LLM**: 6u (11.1%)
...
**🔍 Analyse LLM:**
- **Pattern temporel**: Cycle d'environ 18 jours
- **Saisonnalité**: none
- **Tendance**: Stable à 60u
- **Outliers détectés**: 126u, 120u

**🧠 Raisonnement LLM:**
La dernière commande datant du 21 octobre et le cycle moyen étant d'environ 18 jours, la prochaine commande est prévue aux environs du 8 novembre. Cette date se situe dans la fenêtre des 30 prochains jours. En excluant les pics exceptionnels de septembre et début octobre, la consommation de base se stabilise à 60 unités.
...
**✅ Quantité LLM**: 60u (confidence: high)
**📊 Quantité Réelle**: 54u
...
|---------|-------------|--------|
| [TEN01] TENSAÏ TEA  thé vert bio au citron et à la fleur de sureau 330ml | 20 | Stock prédit: 6.9u (5j restants) → prédit 20u mais non commandé |
| [TEN02] TENSAÏ TEA  thé noir bio au gingembre 330ml | 10 | Stock prédit: 5.1u (11j restants) → prédit 10u mais non commandé |
...
| [ORG04] ORGANICA crunchy fruit fraise 12g | 18 | Stock prédit: 5.1u (4j restants) → prédit 18u mais non commandé |
...
*Rapport généré automatiquement le 2025-12-18T21:33:52.160Z*
