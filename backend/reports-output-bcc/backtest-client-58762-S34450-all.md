...
| Métrique | Valeur | Interprétation |
|----------|--------|----------------|
| **MAE** | 9.55 unités | Erreur moyenne absolue (symétrique) |
| **wMAPE** | 85.4% | Erreur ponderee robuste (metrique principale) |
| **MAPE** | 79.5% | Erreur moyenne en % (biaisé, pour info) |
| **Bias** | -69.1% | Biais directionnel (>0 = surestime, <0 = sous-estime) |
...
<details>
<summary><strong>11. [PF1802] LD MOUTARDE MIEL 250ML WECK</strong> - LLM: 1u vs Médiane: 1u (Réel: 5u)</summary>
...
*Rapport généré automatiquement le 2025-12-30T14:28:23.527Z*
