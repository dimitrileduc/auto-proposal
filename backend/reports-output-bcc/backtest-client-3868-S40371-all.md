...
| Métrique | Valeur | Interprétation |
|----------|--------|----------------|
| **MAE** | 16.86 unités | Erreur moyenne absolue (symétrique) |
| **wMAPE** | 38.6% | Erreur ponderee robuste (metrique principale) |
| **MAPE** | 37.1% | Erreur moyenne en % (biaisé, pour info) |
...
<details>
<summary><strong>14. [LV189] LV Tartinade Houmous Type 380g</strong> - LLM: 75u vs Médiane: 75u (Réel: 25u)</summary>
...
|---------|---------------|--------|
| [VID0009] Consigne casier | 256 | Never ordered in previous analysis window (no history) |
| [VID0010] Consigne casier | 1536 | Never ordered in previous analysis window (no history) |
...
*Rapport généré automatiquement le 2025-12-30T14:05:32.020Z*
