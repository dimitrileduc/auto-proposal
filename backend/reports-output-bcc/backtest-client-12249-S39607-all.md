...
|---------|---------------|--------|
| [VID0009] Consigne casier | 14 | Never ordered in previous analysis window (no history) |
| [VID0010] Consigne casier | 84 | Never ordered in previous analysis window (no history) |
| [MF0042] MF Brotaufstrich Tomate Bärlauch 250g | 1 | Never ordered in previous analysis window (no history) |
...
*Rapport généré automatiquement le 2025-12-30T14:24:00.492Z*
