...
|---------|---------------|--------|
| [MF0058] MF Confi Groseilles Bessen | 2 | Never ordered in previous analysis window (no history) |
| [RF002] REFIELD Passata tomates 500G | 4 | Never ordered in previous analysis window (no history) |
| [VID0009] Consigne casier | 41 | Never ordered in previous analysis window (no history) |
| [VID0010] Consigne casier | 246 | Never ordered in previous analysis window (no history) |
...
*Rapport généré automatiquement le 2025-12-30T14:11:14.413Z*
