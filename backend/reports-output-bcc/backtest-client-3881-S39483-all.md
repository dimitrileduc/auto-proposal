...
|---------|--------|------|-----------|----------|------|------------|------------|--------|
| [PF0549] YVALLI SAUCE PIZZA 2,5 KG | 72 | 48 | 24.0 | 50.0% | partial | Non | Non | LLM |
...
|---------|---------------|--------|
| [PF0509] YVALLI GR BOUL TOMATE 2,5 KG | 3 | Never ordered in previous analysis window (no history) |
| [PF0520] YVALLI PET BOUL TOMATE 2,5 KG | 3 | Never ordered in previous analysis window (no history) |
...
| [PF1539] FILOU BOULETTE CHASSEUR 800G | 1 | Never ordered in previous analysis window (no history) |
...
*Rapport généré automatiquement le 2025-12-30T14:26:57.296Z*
