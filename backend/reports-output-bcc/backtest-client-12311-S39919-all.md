...
|---------|---------------|--------|
| [MF0032] MF Tarti Pois chiches 250 g | 2 | Never ordered in previous analysis window (no history) |
...
| [VID0009] Consigne casier | 32 | Never ordered in previous analysis window (no history) |
| [VID0010] Consigne casier | 192 | Never ordered in previous analysis window (no history) |
...
*Rapport généré automatiquement le 2025-12-30T14:18:16.522Z*
