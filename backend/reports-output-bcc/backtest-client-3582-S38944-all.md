...
|---------|---------------|--------|
| [PF1599] FILOU MAYONNAISE OEUFS SQUEEZE 300ML | 40 | Never ordered in previous analysis window (no history) |
| [PF0093] FILOU MOUTARDE 300GR | 130 | Never ordered in previous analysis window (no history) |
| [PF0094] FILOU MOUTARDE 700 GR | 20 | Never ordered in previous analysis window (no history) |
| [PF0502] FILOU MOUTARDE SQUEEZE 300 ML | 40 | Never ordered in previous analysis window (no history) |
| [PF1845] FILOU SAMOURAI SQUEEZE 300ML | 10 | Never ordered in previous analysis window (no history) |
...
*Rapport généré automatiquement le 2025-12-30T14:17:24.943Z*
