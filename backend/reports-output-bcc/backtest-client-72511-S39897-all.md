...
| Métrique | Valeur | Interprétation |
|----------|--------|----------------|
| **MAE** | 2.60 unités | Erreur moyenne absolue (symétrique) |
| **wMAPE** | 56.5% | Erreur ponderee robuste (metrique principale) |
| **MAPE** | 50.1% | Erreur moyenne en % (biaisé, pour info) |
...
<details>
<summary><strong>5. [JF034] JF SAMOURAI SQUEEZE 300ML</strong> - LLM: 8u vs Médiane: 8u (Réel: 4u)</summary>
...
*Rapport généré automatiquement le 2025-12-30T14:27:43.622Z*
