...
| Métrique | Valeur | Interprétation |
|----------|--------|----------------|
| **MAE** | 3.75 unités | Erreur moyenne absolue (symétrique) |
| **wMAPE** | 69.8% | Erreur ponderee robuste (metrique principale) |
| **MAPE** | 46.6% | Erreur moyenne en % (biaisé, pour info) |
| **Bias** | -69.8% | Biais directionnel (>0 = surestime, <0 = sous-estime) |
...
<details>
<summary><strong>6. [JF012] JF SAUCE BEARNAISE 250ML WECK</strong> - LLM: 2u vs Médiane: 2u (Réel: 10u)</summary>
...
*Rapport généré automatiquement le 2025-12-30T14:12:07.211Z*
