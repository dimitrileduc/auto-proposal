...
|----------|--------|----------------|
| **Précision** | 10.0% | 80 produits prédits, 8 corrects |
...
| Métrique | Valeur | Interprétation |
|----------|--------|----------------|
| **MAE** | 3.38 unités | Erreur moyenne absolue (symétrique) |
| **wMAPE** | 61.4% | Erreur ponderee robuste (metrique principale) |
| **MAPE** | 60.6% | Erreur moyenne en % (biaisé, pour info) |
| **Bias** | -61.4% | Biais directionnel (>0 = surestime, <0 = sous-estime) |
...
|---------|--------|------|-----------|----------|------|--------|
| [LD014] LD Organic Avocado Spread 180 g | 3 | 4 | 1.0 | 25.0% | partial | LLM |
| [LD013] LD Tuscan Organic Spread 180 g | 4 | 8 | 4.0 | 50.0% | partial | LLM |
...
<details>
<summary><strong>8. [LD007] LD Organic Pineapple Coconut Spread 180 g</strong> - LLM: 2u vs Médiane: 2u (Réel: 4u)</summary>
...
<details>
<summary><strong>8. [LD007] LD Organic Pineapple Coconut Spread 180 g</strong> - LLM Reussi</summary>
...
*Rapport généré automatiquement le 2025-12-30T14:06:25.460Z*
