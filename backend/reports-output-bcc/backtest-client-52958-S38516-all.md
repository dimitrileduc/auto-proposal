...
|---------|--------|------|-----------|----------|------|--------|
| [PF1854] JACKY MAYONNAISE OEUFS SQUEEZE 300ML | 80 | 80 | 0.0 | 0.0% | exact | LLM |
...
|---------|---------------|--------|
| [PF1852] JACKY POIVRE SQUEEZE 300ML | 40 | Never ordered in previous analysis window (no history) |
...
*Rapport généré automatiquement le 2025-12-30T14:15:30.840Z*
