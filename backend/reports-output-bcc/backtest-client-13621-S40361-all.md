...
|----------|--------|----------------|
| **Précision** | 0.4% | 268 produits prédits, 1 corrects |
| **Rappel** | 100.0% | 1 produits réels, 1 détectés |
| **F1-Score** | 0.7% | Score equilibre global |
...
|---------|--------|------|-----------|----------|------|--------|
| [PF0088] FILOU VOL AU VENT 800 GR | 24 | 30 | 6.0 | 20.0% | partial | LLM |
...
*Rapport généré automatiquement le 2025-12-30T14:04:41.615Z*
