...
|---------|---------------|--------|
| [VID0009] Consigne casier | 17 | Never ordered in previous analysis window (no history) |
| [VID0010] Consigne casier | 102 | Never ordered in previous analysis window (no history) |
...
*Rapport généré automatiquement le 2025-12-30T14:06:15.758Z*
