# Auto-Proposal Report - Hyper St Agathe Berchem

**Client:** Hyper St Agathe Berchem (ID: 17282)
**Analysis Date:** 12/30/2025, 3:08:13 PM
**Replenishment Threshold:** 30 days

## Summary

- **Core Products:** 22 (794.04€ excl. tax)
- **Optional Products:** 0 (0.00€ excl. tax)
- **Total:** 794.04€ excl. tax
...
| [JF008] JF MAYONNA DU CHEF 470 ML WECK | 3 TU6 | 25.80€ | 77.40€ | 🟢 High |
| [JF002] JF MAYONNAI BASILIC 250ML WECK | 2 TU6 | 19.50€ | 39.00€ | 🟢 High |
| [JF003] JF MAYONNAIS WASABI 250ML WECK | 1 TU6 | 19.50€ | 19.50€ | 🟢 High |
| [JF004] JF MAYONNAIS POIVRE 250ML WECK | 1 TU6 | 19.50€ | 19.50€ | 🟢 High |
| [JF005] JF MAYONNAISE OEUFS 250ML WECK | 3 TU6 | 19.50€ | 58.50€ | 🟢 High |
| [JF022] JF MOUTARDE MIEL 250ML WECK | 1 TU6 | 19.50€ | 19.50€ | 🟡 Medium |
...
| [JF012] JF SAUCE BEARNAISE 250ML WECK | 2 TU6 | 19.50€ | 39.00€ | 🟢 High |
...
| [JF001] JF MAYONNAI TRUFFES 250ML WECK | 4 TU6 | 23.40€ | 93.60€ | 🟢 High |
| [JF019] JF SAUCE AIOLI PESTO 250M WECK | 1 TU6 | 21.00€ | 21.00€ | 🟡 Medium |
| [JF023] JF MOUTARDE DOUCE 250ML WECK | 1 TU6 | 19.50€ | 19.50€ | 🟡 Medium |
| [JF028] JF VINAIGRET CAESAR WECK 200ML | 1 TU9 | 27.00€ | 27.00€ | 🟡 Medium |
| [JF014] JF SAUCE BEARNAISE 470ML WECK | 2 TU6 | 25.80€ | 51.60€ | 🟢 High |
| [JF020] JF SAUCE AIOLI 250ML WECK | 2 TU6 | 19.50€ | 39.00€ | 🟢 High |
| [JF021] JF PICKLES 350 ML | 1 TU6 | 20.94€ | 20.94€ | 🟢 High |
...
<details>
<summary><strong>[JF008] JF MAYONNA DU CHEF 470 ML WECK</strong> - 3 TU6 (77.40€)</summary>
...
<details>
<summary><strong>[JF002] JF MAYONNAI BASILIC 250ML WECK</strong> - 2 TU6 (39.00€)</summary>
...
ÉTAPE 1 : Détection du besoin. Le cycle entre les deux dernières commandes est d'environ 83 jours. La dernière commande date du 01/09/2025, soit 49 jours écoulés. Bien que nous ne soyons pas encore au terme du cycle théorique, le délai de réapprovisionnement de 30 jours porte l'horizon à 79 jours après la dernière commande (proche du cycle de 83j). En application du principe de précaution B2B et face à un historique restreint rendant le cycle incertain, un risque de rupture est identifié. ÉTAPE 2 : Estimation de la quantité. L'historique montre des commandes de 1u et 2u. Conformément à la règle de privilégier la valeur la plus basse en cas de doute sur une faible rotation, la quantité retenue est de 1 unité.
...
ÉTAPE 1 : Détection du besoin. Le cycle entre les deux dernières commandes est d'environ 83 jours. La dernière commande date du 01/09/2025, soit 49 jours avant la date actuelle. Bien que nous ne soyons qu'à 60% du cycle moyen, le seuil de réapprovisionnement de 30 jours nous place dans une fenêtre de risque de rupture (49 + 30 = 79 jours, proche du cycle de 83). Par principe de précaution B2B, un besoin est détecté. ÉTAPE 2 : Estimation quantité. L'historique montre des volumes très faibles (1u et 2u). Conformément à la règle sur les rotations faibles et le choix de la valeur la plus basse en cas de doute, la quantité retenue est de 1 unité.
...
ÉTAPE 1 : Détection du besoin. L'historique montre une rotation lente mais régulière avec un cycle moyen d'environ 42 jours (34 jours entre juin et juillet, 59 jours entre juillet et septembre). La dernière commande date du 01/09/2025, soit 49 jours écoulés. Nous avons dépassé le cycle moyen et le seuil de 70% du cycle. Le risque de rupture est élevé dans l'horizon des 30 jours (Replenishment Threshold Days). ÉTAPE 2 : Estimation quantité. La médiane des commandes récentes est strictement de 1 unité. Conformément à la règle sur les rotations faibles (1-2u), on maintient la quantité habituelle sans l'augmenter.
...
ÉTAPE 1 : Le cycle entre les deux dernières commandes est de 83 jours. Depuis la dernière commande (01/09/2025), 49 jours se sont écoulés. Bien que nous soyons à environ 60% du cycle précédent, l'irrégularité de l'historique et le principe de précaution B2B imposent de prévoir un besoin pour couvrir l'horizon des 30 prochains jours (seuil de réapprovisionnement), afin d'éviter une rupture sur un produit à rotation lente. ÉTAPE 2 : L'historique montre des quantités de 1u et 2u. Conformément à la règle de privilégier la valeur la plus basse en cas de doute sur une faible rotation, la quantité retenue est de 1 unité.
...
<details>
<summary><strong>[JF012] JF SAUCE BEARNAISE 250ML WECK</strong> - 2 TU6 (39.00€)</summary>
...
ÉTAPE 1 : Détection du besoin. Le cycle observé entre les deux dernières commandes est d'environ 83 jours. La dernière commande date du 01/09/2025, soit 49 jours écoulés. Bien que nous soyons à environ 60% du cycle moyen, l'approche de précaution B2B s'applique ici car le produit présente une rotation très faible et irrégulière. Un risque de rupture existe dans l'horizon des 30 jours (Replenishment Threshold Days). ÉTAPE 2 : Estimation quantité. L'historique récent montre une stabilité stricte à 1 unité par commande. Conformément à la règle sur les rotations faibles (1-2u), la quantité maintenue est de 1 unité.
...
<details>
<summary><strong>[JF001] JF MAYONNAI TRUFFES 250ML WECK</strong> - 4 TU6 (93.60€)</summary>
...
La dernière commande remonte au 01/09/2025, soit 49 jours avant la date actuelle. Bien que la rotation soit très faible et irrégulière (une seule commande récente de 1u et une commande l'année précédente à une période différente), le délai écoulé depuis la dernière livraison justifie un réapprovisionnement par précaution pour éviter une rupture de stock prolongée sur les 30 prochains jours. Conformément aux règles de gestion des rotations faibles (1-2u), la quantité retenue est de 1 unité, correspondant à la commande la plus récente.
...
L'analyse de l'historique montre un cycle de commande d'environ 60 jours (entre juillet et septembre). Au 20 octobre, 49 jours se sont écoulés depuis la dernière commande, ce qui représente 81% du cycle moyen. Ce dépassement du seuil de 70% indique un risque de rupture imminent dans l'horizon des 30 jours (Replenishment Threshold Days). En application du principe de précaution B2B et face à une rotation faible mais régulière, la quantité retenue correspond à la médiane des commandes récentes, soit 1 unité.
...
L'analyse montre un cycle de commande irrégulier avec une dernière commande effectuée il y a 49 jours (01/09). Bien que la rotation soit faible, le délai écoulé dépasse largement l'intervalle précédent (59 jours), créant une incertitude sur le stock actuel. En application du principe de précaution B2B (détection d'un besoin incertain pour éviter la rupture), une commande est préconisée. La quantité retenue est de 1 unité, correspondant à la valeur basse de l'historique récent (médiane entre 1u et 2u, choix du plus bas en cas de doute).
...
<details>
<summary><strong>[JF014] JF SAUCE BEARNAISE 470ML WECK</strong> - 2 TU6 (51.60€)</summary>
...
<details>
<summary><strong>[JF020] JF SAUCE AIOLI 250ML WECK</strong> - 2 TU6 (39.00€)</summary>
...
<details>
<summary><strong>[JF021] JF PICKLES 350 ML</strong> - 1 TU6 (20.94€)</summary>
...
- **Stock Analysis:** 22 at-risk products detected
- **Proposal Final:** 22 products after pricing
...
*Report auto-generated on 12/30/2025, 3:08:13 PM*