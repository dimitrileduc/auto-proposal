...
|---------|---------------|--------|
| [VID0009] Consigne casier | 64 | Never ordered in previous analysis window (no history) |
| [VID0010] Consigne casier | 384 | Never ordered in previous analysis window (no history) |
...
*Rapport généré automatiquement le 2025-12-30T14:20:47.190Z*
