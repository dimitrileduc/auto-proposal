...
| Métrique | Valeur | Interprétation |
|----------|--------|----------------|
| **MAE** | 53.67 unités | Erreur moyenne absolue (symétrique) |
| **wMAPE** | 48.6% | Erreur ponderee robuste (metrique principale) |
| **MAPE** | 44.0% | Erreur moyenne en % (biaisé, pour info) |
| **Bias** | -41.4% | Biais directionnel (>0 = surestime, <0 = sous-estime) |
...
<details>
<summary><strong>6. [PF0959] FILOU TOMATO KETCHUP 10KG</strong> - LLM: 52u vs Médiane: 52u (Réel: 44u)</summary>
...
*Rapport généré automatiquement le 2025-12-30T14:06:32.758Z*
