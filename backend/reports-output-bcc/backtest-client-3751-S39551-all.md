...
|---------|--------|------|-----------|----------|------|--------|
| [PF0075] FILOU CHASSEUR  10 L | 4 | 5 | 1.0 | 20.0% | partial | LLM |
...
| [PF1844] FILOU ANDALOUSE SQUEEZE 300ML | 1 | Predicted 1u but not ordered |
...
|---------|---------------|--------|
| [PF0096] FILOU MOUTARDE 3 KG | 1 | Never ordered in previous analysis window (no history) |
...
*Rapport généré automatiquement le 2025-12-30T14:18:16.095Z*
