...
- **Date d'exécution** : 19/12/2025 10:37:15
- **Clients analysés** : 10
- **Clients réussis** : 10
- **Clients échoués** : 0
...
|----------|---------|---------|----------------|
| **Recall** | 100.0% | 100.0% | % de besoins réels détectés |
| **Precision** | 42.8% | 50.0% | % de prédictions correctes (50.0% proposés non commandés) |
| **F1-Score** | 56.1% | 66.7% | Équilibre détection/précision |
| **wMAPE** | 47.2% | 26.5% | ⚖️ Écart pondéré robuste (métrique principale) |
| **MAPE** | 48.1% | 29.1% | Écart moyen (info, biaisé) |
| **Bias** | 25.4% | 5.0% | Biais directionnel (>0 = surestime, <0 = sous-estime) |
...
|----------|--------|----------------|
| **Appels LLM** | 140 | Nombre de produits prédits par LLM (>2 commandes historiques) |
| **Tokens Total** | 769 389 | 349 762 prompt + 419 627 completion |
| **Tokens Moyen/Appel** | 5 496 | Tokens moyen par prédiction LLM |
...
**Comment se répartissent les 10 clients ?**
...
*Rapport généré automatiquement le 2025-12-19T09:37:15.357Z*
