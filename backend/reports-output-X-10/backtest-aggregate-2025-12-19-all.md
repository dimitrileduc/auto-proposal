...
|----------|---------|---------|----------------|
| **Recall** | 86.6% | 100.0% | % de besoins réels détectés |
| **Precision** | 42.9% | 50.0% | % de prédictions correctes (50.0% proposés non commandés) |
| **F1-Score** | 54.4% | 66.7% | Équilibre détection/précision |
| **wMAPE** | 47.1% | 26.5% | ⚖️ Écart pondéré robuste (métrique principale) |
| **MAPE** | 48.0% | 29.1% | Écart moyen (info, biaisé) |
| **Bias** | 25.3% | 4.5% | Biais directionnel (>0 = surestime, <0 = sous-estime) |
...
*Rapport généré automatiquement le 2025-12-19T09:37:15.370Z*
