...
| Métrique | Valeur | Interprétation |
|----------|--------|----------------|
| **MAE** | 9.56 unités | Erreur moyenne absolue (métrique principale) |
...
|---------|-------------|--------|
| [FIL21] FIL BOULETTES SAUCE CHASSEUR 800G BOCAL  | 48 | Stock prédit: 0.0u (0j restants) → prédit 48u mais non commandé |
...
| [JF026] JF VINAIGRET TRUFFES WECK 200M | 21 | Jamais commandé avant dans les 270j précédents (pas d'historique) |


---

*Rapport généré automatiquement le 2025-11-14T09:37:16.274Z*
