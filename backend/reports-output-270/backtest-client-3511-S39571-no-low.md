...
| Métrique | Valeur | Interprétation |
|----------|--------|----------------|
| **MAE** | 16.50 unités | Erreur moyenne absolue (métrique principale) |
| **MAPE** | 35.2% | Erreur moyenne en % (complémentaire) |
...
|---------|-------------|--------|
| [PF0097] FILOU MOUTARDE 5 KG | 30 | Stock prédit: -0.8u (0j restants) → prédit 30u mais non commandé |
| [PF0089] FILOU VOL AU VENT 400 GR | 4 | Stock prédit: -4.7u (-32j restants) → prédit 4u mais non commandé |
...
*Rapport généré automatiquement le 2025-11-14T09:37:03.352Z*
