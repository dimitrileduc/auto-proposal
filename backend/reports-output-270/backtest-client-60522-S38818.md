...
| Métrique | Valeur | Interprétation |
|----------|--------|----------------|
| **MAE** | 3.00 unités | Erreur moyenne absolue (métrique principale) |
...
|---------|--------|------|-----------|----------|------|
| [PAO04] PAOLA cola ZERO canette 330ml - le cola des Belges  | 4 | 10 | 6.0 | 60.0% | ✅ partial |
...
| [PAO03] PAOLA cola canette 330ml - le cola des Belges | 3 | Stock prédit: -2.4u (-24j restants) → prédit 3u mais non commandé |
...
|---------|---------------|--------|
| [NUT05] NUTS & BERRIES Bar choco noir gingembre bio 40g | 2 | Jamais commandé avant dans les 270j précédents (pas d'historique) |


---

*Rapport généré automatiquement le 2025-11-14T09:38:48.801Z*
