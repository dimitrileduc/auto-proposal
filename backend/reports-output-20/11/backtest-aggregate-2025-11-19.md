...
- **Date d'exécution** : 19/11/2025 21:03:46
- **Clients analysés** : 48
- **Clients réussis** : 48
- **Clients échoués** : 0
...
| **wMAPE** | 29.5% | 25.0% | ⚖️ Écart pondéré robuste (métrique principale) |
| **MAPE** | 34.3% | 31.6% | Écart moyen (info, biaisé) |
...
|----------|--------|----------------|
| **Appels LLM** | 802 | Nombre de produits prédits par LLM (>2 commandes historiques) |
| **Tokens Total** | 1 859 772 | 1 662 296 prompt + 197 476 completion |
| **Coût Total** | $7.9490 | Claude Sonnet 4.5: $3/$15 per million tokens |
| **Coût Moyen/Client** | $0.1656 | Coût moyen par client analysé |
| **Coût Moyen/Appel** | $0.009912 | Coût moyen par prédiction LLM |
...
*Rapport généré automatiquement le 2025-11-19T20:03:46.754Z*
