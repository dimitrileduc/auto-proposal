...
- **Date d'exécution** : 18/12/2025 13:25:25
- **Clients analysés** : 48
- **Clients réussis** : 48
- **Clients échoués** : 0
...
| **wMAPE** | 31.4% | 25.8% | ⚖️ Écart pondéré robuste (métrique principale) |
| **MAPE** | 36.0% | 32.2% | Écart moyen (info, biaisé) |
| **Bias** | 3.6% | 0.0% | Biais directionnel (>0 = surestime, <0 = sous-estime) |
...
|----------|--------|----------------|
| **Appels LLM** | 880 | Nombre de produits prédits par LLM (>2 commandes historiques) |
| **Tokens Total** | 2 252 069 | 861 513 prompt + 1 390 556 completion |
| **Tokens Moyen/Appel** | 2 559 | Tokens moyen par prédiction LLM |
...
*Rapport généré automatiquement le 2025-12-18T12:25:25.752Z*
