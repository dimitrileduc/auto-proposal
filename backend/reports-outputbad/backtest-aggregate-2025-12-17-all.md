...
|----------|---------|---------|----------------|
| **Recall** | 84.7% | 100.0% | % de besoins réels détectés |
| **Precision** | 37.0% | 35.5% | % de prédictions correctes (64.5% proposés non commandés) |
| **F1-Score** | 45.9% | 52.0% | Équilibre détection/précision |
| **wMAPE** | 41.6% | 36.4% | ⚖️ Écart pondéré robuste (métrique principale) |
| **MAPE** | 44.8% | 45.0% | Écart moyen (info, biaisé) |
| **Bias** | -3.0% | 0.0% | Biais directionnel (>0 = surestime, <0 = sous-estime) |
...
**Comment se répartissent les 39 clients ?**
...
*Rapport généré automatiquement le 2025-12-17T16:32:28.697Z*
