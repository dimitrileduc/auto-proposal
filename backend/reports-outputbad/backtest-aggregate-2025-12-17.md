...
- **Date d'exécution** : 17/12/2025 17:32:28
- **Clients analysés** : 49
- **Clients réussis** : 38
- **Clients échoués** : 11
...
|----------|---------|---------|----------------|
| **Recall** | 97.9% | 100.0% | % de besoins réels détectés |
| **Precision** | 38.3% | 39.3% | % de prédictions correctes (60.7% proposés non commandés) |
| **F1-Score** | 49.4% | 56.4% | Équilibre détection/précision |
| **wMAPE** | 42.5% | 36.6% | ⚖️ Écart pondéré robuste (métrique principale) |
| **MAPE** | 45.0% | 44.0% | Écart moyen (info, biaisé) |
| **Bias** | -3.1% | -1.2% | Biais directionnel (>0 = surestime, <0 = sous-estime) |
...
|----------|--------|----------------|
| **Appels LLM** | 651 | Nombre de produits prédits par LLM (>2 commandes historiques) |
| **Tokens Total** | 3 008 844 | 977 229 prompt + 2 031 615 completion |
| **Tokens Moyen/Appel** | 4 622 | Tokens moyen par prédiction LLM |
...
*Rapport généré automatiquement le 2025-12-17T16:32:28.672Z*
