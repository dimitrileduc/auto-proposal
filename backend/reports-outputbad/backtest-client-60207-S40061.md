...
- **Appels**: 6
- **Tokens**: 8,540 input + 17,386 output = 25,926 total
...
| Métrique | Valeur | Interprétation |
|----------|--------|----------------|
| **MAE** | 69.00 unités | Erreur moyenne absolue (symétrique) |
| **wMAPE** | 127.8% | ⚖️ Erreur pondérée robuste (métrique principale) |
| **MAPE** | 127.8% | Erreur moyenne en % (biaisé, pour info) |
| **Bias** | 127.8% | Biais directionnel (>0 = surestime, <0 = sous-estime) |
...
|---------|--------|------|-----------|----------|------|------------|------------|--------|
| [MATE01] MATE MATE thé glacé bio pétillant au yerba maté verre 330ml | 123 | 54 | 69.0 | 127.8% | ✅ partial | ✅ Oui | ✅ Oui | 🤖 LLM |
...
<details>
<summary><strong>1. [MATE01] MATE MATE thé glacé bio pétillant au yerba maté verre 330ml</strong> - LLM: 123u vs Médiane: 120u (Réel: 54u)</summary>

**Quantités:**
- 🤖 **LLM prédit**: 123u (confidence: high)
- 📊 **Baseline N-1**: 123u
- 📊 **Médiane**: 120u
- ✅ **Réel commandé**: 54u
- 📉 **Erreur LLM**: 69u (127.8%)
- 📉 **Erreur Médiane**: 66u (122.2%)

**🔍 Analyse LLM:**
- **Pattern temporel**: cycle irregular 13-21 jours avec preference mardi
- **Saisonnalité**: none
- **Tendance**: dual pattern: major (120-126u) / minor (54-60u)
- **Outliers détectés**: Aucun

**🧠 Raisonnement LLM:**
Pattern majoritaire de 120-126u sur 21j identifié. La valeur 54u est un outlier temporel et volumétrique (commande d'appoint). En agro B2B, on privilégie le pattern récurrent dominant sur les exceptions ponctuelles. Le dimanche étant hors cycle, la prédiction porte sur la prochaine commande réelle attendue.
...
**✅ Quantité LLM**: 123u (confidence: high)
**📊 Quantité Réelle**: 54u
...
| [ORG01] ORGANICA crunchy fruit ananas 16g | 8 | Stock prédit: -11.7u (-65j restants) → prédit 8u mais non commandé |
| [ORG10] ORGANICA crunchy fruit mangue 18g | 0 | Stock prédit: -19.6u (-59j restants) → prédit 0u mais non commandé |
...
*Rapport généré automatiquement le 2025-12-17T16:30:05.061Z*
