...
- **Appels**: 6
- **Tokens**: 5,740 input + 9,098 output = 14,838 total
...
| Métrique | Valeur | Interprétation |
|----------|--------|----------------|
| **MAE** | 191.00 unités | Erreur moyenne absolue (symétrique) |
| **wMAPE** | 74.2% | ⚖️ Erreur pondérée robuste (métrique principale) |
| **MAPE** | 72.9% | Erreur moyenne en % (biaisé, pour info) |
| **Bias** | -74.2% | Biais directionnel (>0 = surestime, <0 = sous-estime) |
...
|---------|--------|------|-----------|----------|------|------------|------------|--------|
| [PF3354] DLL DRESSING AVOCAT BALSAMICO 240ML | 15 | 273 | 258.0 | 94.5% | ✅ partial | ✅ Oui | ✅ Oui | 🤖 LLM |
...
<details>
<summary><strong>1. [PF3354] DLL DRESSING AVOCAT BALSAMICO 240ML</strong> - LLM: 15u vs Médiane: 165u (Réel: 273u)</summary>
...
- 📊 **Médiane**: 165u
- ✅ **Réel commandé**: 273u
- 📉 **Erreur LLM**: 258u (94.5%)
- 📉 **Erreur Médiane**: 108u (39.6%)

**🔍 Analyse LLM:**
- **Pattern temporel**: irrégulier - seule une commande observée sur 3 mois
- **Saisonnalité**: none
- **Tendance**: stable (insuffisamment de données)
- **Outliers détectés**: Aucun

**🧠 Raisonnement LLM:**
Avec une seule commande de 20u datant de mi-août et aucune récurrence depuis près de 3 mois, le pattern d'usage est inconnu. La valeur recommandée de 15 unités adopte une approche prudente, légèrement inférieure à la commande test initiale pour éviter la sur-prévision tout en restant cohérente avec un potentiel réapprovisionnement ponctuel.
...
**🔍 Analyse LLM:**
- **Pattern temporel**: irrégulier (une seule commande en 3 mois, cycle indéterminé)
- **Saisonnalité**: none
- **Tendance**: stable (pas de données N-1 pour comparer)
- **Outliers détectés**: Aucun

**🧠 Raisonnement LLM:**
Avec une seule commande historique, 118u constitue notre seule référence fiable. Maintien de cette valeur comme prédiction prudente, mais très incertaine car impossible de détecter un pattern stable. Le risque de sur-prévision est limité en restant sur la seule donnée observable.
...
| [PF3355] DLL DRESSING AVOCAT POPPY SEEDS 240ML | 240 | Stock prédit: -167.6u (-23j restants) → prédit 240u mais non commandé |
...
*Rapport généré automatiquement le 2025-12-17T12:12:09.969Z*
