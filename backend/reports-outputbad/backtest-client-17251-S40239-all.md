...
- **Appels**: 13
- **Tokens**: 20,551 input + 39,294 output = 59,845 total
...
**🔍 Analyse LLM:**
- **Pattern temporel**: Commande mensuelle irrégulière avec préférence mardi. Dernière commande valide: vendredi 31/10 (112u). Avant-dernière: mardi 21/10 (112u). Cycle dominant: 21 jours entre mardis valides.
- **Saisonnalité**: none
- **Tendance**: stable
- **Outliers détectés**: -1u

**🧠 Raisonnement LLM:**
Toutes les commandes valides (4/5) sont à 112u sans exception. Le mardi est le jour dominant (3/4). L'intervalle de 21j entre mardis se répète. L'unique 0 du 16/10 (jeudi) est un outlier de test/erreur car suivi immédiatement d'une commande normale. En B2B agro, un pattern stable à 112u se répète jusqu'à preuve contraire. La prochaine commande mardi suivra ce pattern.
...
| [PF3225] CARREFOUR CARBONNADES 680 GR PAR 8 | 108 | Stock prédit: -17.5u (-1j restants) → prédit 108u mais non commandé |
| [PF3340] CARRE MAYONNAISE BELGE 720ML | 80 | Stock prédit: -48.0u (-3j restants) → prédit 80u mais non commandé |
| [PF3343] SIMPL CARRE VOL AU VENT 800 GR | 96 | Stock prédit: 7.4u (0j restants) → prédit 96u mais non commandé |
...
*Rapport généré automatiquement le 2025-12-17T16:23:55.988Z*
