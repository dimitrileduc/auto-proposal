...
- **Date d'exécution** : 18/12/2025 13:02:48
- **Clients analysés** : 48
- **Clients réussis** : 48
- **Clients échoués** : 0
...
| **wMAPE** | 35.1% | 26.3% | ⚖️ Écart pondéré robuste (métrique principale) |
| **MAPE** | 40.4% | 33.3% | Écart moyen (info, biaisé) |
| **Bias** | 5.8% | 0.0% | Biais directionnel (>0 = surestime, <0 = sous-estime) |
...
|----------|--------|----------------|
| **Appels LLM** | 882 | Nombre de produits prédits par LLM (>2 commandes historiques) |
| **Tokens Total** | 1 181 236 | 864 565 prompt + 316 671 completion |
| **Tokens Moyen/Appel** | 1 339 | Tokens moyen par prédiction LLM |
...
*Rapport généré automatiquement le 2025-12-18T12:02:48.455Z*
