...
|----------|--------|----------------|
| **Précision** | 6.8% | 44 produits prédits, 3 corrects |
| **Rappel** | 100.0% | 3 produits réels, 3 détectés |
| **F1-Score** | 12.8% | Score équilibré global |
...
|---------|-------------|--------|
| [DIS0011] Display Foodprint Karton LV | 52 | Stock prédit: 44.9u (37j restants) → prédit 52u mais non commandé |
...
*Rapport généré automatiquement le 2025-12-19T09:02:25.091Z*
