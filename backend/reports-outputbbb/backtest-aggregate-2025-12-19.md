...
- **Date d'exécution** : 19/12/2025 10:04:19
- **Clients analysés** : 47
- **Clients réussis** : 30
- **Clients échoués** : 17
...
| **Precision** | 38.6% | 48.8% | % de prédictions correctes (51.2% proposés non commandés) |
| **F1-Score** | 50.2% | 65.6% | Équilibre détection/précision |
| **wMAPE** | 52.6% | 32.3% | ⚖️ Écart pondéré robuste (métrique principale) |
| **MAPE** | 61.7% | 46.6% | Écart moyen (info, biaisé) |
| **Bias** | 26.8% | 3.3% | Biais directionnel (>0 = surestime, <0 = sous-estime) |
...
| **Tokens Total** | 3 652 640 | 1 758 873 prompt + 1 893 767 completion |
| **Tokens Moyen/Appel** | 4 600 | Tokens moyen par prédiction LLM |
...
**Comment se répartissent les 30 clients ?**
...
*Rapport généré automatiquement le 2025-12-19T09:04:19.938Z*
