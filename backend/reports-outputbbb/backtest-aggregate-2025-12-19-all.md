...
|----------|---------|---------|----------------|
| **Recall** | 83.4% | 100.0% | % de besoins réels détectés |
| **Precision** | 37.3% | 47.6% | % de prédictions correctes (52.4% proposés non commandés) |
| **F1-Score** | 45.6% | 52.4% | Équilibre détection/précision |
| **wMAPE** | 52.1% | 31.3% | ⚖️ Écart pondéré robuste (métrique principale) |
| **MAPE** | 59.2% | 46.4% | Écart moyen (info, biaisé) |
| **Bias** | 27.0% | 2.1% | Biais directionnel (>0 = surestime, <0 = sous-estime) |
...
**Comment se répartissent les 31 clients ?**
...
*Rapport généré automatiquement le 2025-12-19T09:04:19.946Z*
