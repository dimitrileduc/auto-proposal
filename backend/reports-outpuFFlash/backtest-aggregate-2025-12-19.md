...
| **Precision** | 42.6% | 41.7% | % de prédictions correctes (58.3% proposés non commandés) |
| **F1-Score** | 54.6% | 58.8% | Équilibre détection/précision |
| **wMAPE** | 31.9% | 29.2% | ⚖️ Écart pondéré robuste (métrique principale) |
| **MAPE** | 37.5% | 33.3% | Écart moyen (info, biaisé) |
| **Bias** | 8.5% | 0.0% | Biais directionnel (>0 = surestime, <0 = sous-estime) |
...
|----------|--------|----------------|
| **Appels LLM** | 1247 | Nombre de produits prédits par LLM (>2 commandes historiques) |
| **Tokens Total** | 3 884 404 | 852 110 prompt + 3 032 294 completion |
| **Tokens Moyen/Appel** | 3 115 | Tokens moyen par prédiction LLM |
...
*Rapport généré automatiquement le 2025-12-19T13:05:10.295Z*
