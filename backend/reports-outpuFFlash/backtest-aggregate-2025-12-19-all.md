...
|----------|---------|---------|----------------|
| **Recall** | 82.0% | 89.4% | % de besoins réels détectés |
| **Precision** | 41.1% | 40.7% | % de prédictions correctes (59.3% proposés non commandés) |
| **F1-Score** | 50.8% | 53.7% | Équilibre détection/précision |
| **wMAPE** | 31.3% | 27.5% | ⚖️ Écart pondéré robuste (métrique principale) |
| **MAPE** | 36.7% | 33.3% | Écart moyen (info, biaisé) |
| **Bias** | 8.4% | 0.0% | Biais directionnel (>0 = surestime, <0 = sous-estime) |
...
*Rapport généré automatiquement le 2025-12-19T13:05:10.305Z*
