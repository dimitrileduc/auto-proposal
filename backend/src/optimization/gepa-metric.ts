 ...
 */
export function gepaMultiObjectiveMetric({
  prediction,
  example,
}: MetricInput): { recall: number; precision: number; accuracy: number } {
 ...
 */
export function gepaCombinedMetric({ prediction, example }: MetricInput): number {
