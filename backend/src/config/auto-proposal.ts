...
export const autoProposalConfig = {
  ...
  /** Default selling company ID (FOODPRINT SRL = 3) */
  defaultCompanyId: 3,
  ...
  inactivityDetection: {
    ...
    /** Partner tag ID to permanently exclude clients from analysis (Odoo prod: "Exclude-Auto-Proposal") */
  ...
  quoteGeneration: {
    /** CRM tag ID for auto-generated proposals (Odoo prod: "Auto-Proposal") */
    autoProposalTagId: 84,
