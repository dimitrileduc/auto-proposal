...
import type { OdooClient, EmailSendResult } from "../../infrastructure/odoo/clients/odoo-client.types";
import type { EmailConfig } from "./email-sending.types";
...
export async function sendQuoteEmail(
  ...
  try {
    ...
    const result = await odooClient.sendQuoteByEmail(
      ...
      clientEmail,
      config.testMode,
      testEmail  // Utilise l'email flexible
    );
